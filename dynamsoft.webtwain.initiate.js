...
dynamsoft.lib.win = window;
(function(lib, undefined) {
	var OP = Object.prototype,
		AP = Array.prototype,
		_utilities_ver = 20180115,
	...
	if (dynamsoft.lib._utilities_ver) {
		if (dynamsoft.lib._utilities_ver >= _utilities_ver) {
			return
		}
	}
	dynamsoft.lib._utilities_ver = _utilities_ver;
...
(function(s) {
	var v = 20180115;
	if (s._sizzle_ver) {
		if (s.isNumber(s._sizzle_ver) && s._sizzle_ver >= v) {
			return
		}
	}
	s._sizzle_ver = v;
	var ap, g = RegExp,
		ad, aa, d, k, t, ak, X, T, r, u, o, p, an = !0,
		f, L, b, R, al = "dws_" + 1 * new Date(),
		am = window.document,
		J = 0,
		x = 0,
		ah = at(),
		...
		af = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
		P = "[\\x20\\t\\r\\n\\f]",
		A = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+",
		ac = ["\\[", P, "*(", A, ")(?:", P, "*([*^$|!~]?=)", P, "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(", A, "))|)", P, "*\\]"].join(""),
		C = new g(P + "+", "g"),
		...
		V = {
			...
			TAG: new g("^(" + A + "|[*])"),
			ATTR: new g("^" + ac),
			needsContext: new g(["^", P, "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(", P, "*((?:-\\d)?\\d*)", P, "*\\)|)(?=[^-]|$)"].join(""), "i")
		},
		K = /^[^{]+\{\s*\[native \w/,
		ab = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
		Q = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,
		l = function(i, e) {
			if (e) {
				if (i === "\0") {
					return "\uFFFD"
	...
	try {
		aj.apply((H = D.call(am.childNodes)), am.childNodes);
		H[am.childNodes.length].nodeType
	} catch (ar) {
		aj = {
			apply: H.length ? function(i, e) {
				Z.apply(i, D.call(e))
			} : function(aw, av) {
				var e = aw.length,
					au = 0;
	...
	function ae(aA, au, aD, aG) {
		var ay, aE, ax, e, aF, aw, aB, av = au && au.ownerDocument,
			aC = au ? au.nodeType : 9;
		aD = aD || [];
		if (typeof aA !== "string" || !aA || aC !== 1 && aC !== 9 && aC !== 11) {
			return aD
		}
		if (!aG) {
			if ((au ? au.ownerDocument || au : am) !== o) {
				u(au)
			}
			au = au || o;
			if (aC !== 11 && (aF = ab.exec(aA))) {
				if ((ay = aF[1])) {
					if (aC === 9) {
						if ((ax = au.getElementById(ay))) {
							if (ax.id === ay) {
								aD.push(ax);
								return aD
							}
						...
						if (av && (ax = av.getElementById(ay)) && R(au, ax) && ax.id === ay) {
							aD.push(ax);
							return aD
						}
					}
					...
					if (aF[2]) {
						aj.apply(aD, au.getElementsByTagName(aA));
						return aD
					} else {
						if ((ay = aF[3]) && ad.getElementsByClassName && au.getElementsByClassName) {
							aj.apply(aD, au.getElementsByClassName(ay));
							return aD
						}
					}
				}
			}
			if (ad.qsa && !F[aA + " "] && (!f || !f.test(aA))) {
				if (aC !== 1) {
					av = au;
					aB = aA
				} else {
					if (au.nodeName.toLowerCase() !== "object") {
						if ((e = au.getAttribute("id"))) {
							e = e.replace(Q, l)
						} else {
							au.setAttribute("id", (e = al))
						}
						aw = k(aA);
						aE = aw.length;
						while (aE--) {
				...
				if (aB) {
					try {
						aj.apply(aD, av.querySelectorAll(aB));
						return aD
					} catch (az) {} finally {
						if (e === al) {
		...
		return ak(aA.replace(ag, "$1"), au, aD, aG)
	}
	...
	function j(i, e) {
		var av = e && i,
			au = av && i.nodeType === 1 && e.nodeType === 1 && i.sourceIndex - e.sourceIndex;
		if (au) {
			return au
		}
		if (av) {
	...
	ad = ae.support = {};
	u = ae.setDocument = function(au) {
		var e, i, av = au ? au.ownerDocument || au : am;
		if (av === o || av.nodeType !== 9 || !av.documentElement) {
			return o
		}
		o = av;
		p = o.documentElement;
		if (am !== o && (i = o.defaultView) && i.top !== i) {
		...
		ad.attributes = Y(function(aw) {
			aw.className = "i";
			return !aw.getAttribute("className")
		});
		ad.getElementsByTagName = Y(function(aw) {
			aw.appendChild(o.createComment(""));
			return !aw.getElementsByTagName("*").length
		});
		ad.getElementsByClassName = K.test(o.getElementsByClassName);
		ad.getById = Y(function(aw) {
			p.appendChild(aw).id = al;
			return !o.getElementsByName || !o.getElementsByName(al).length
		});
		if (ad.getById) {
			aa.filter.ID = function(ax) {
				var aw = ax;
				return function(ay) {
					return ay.getAttribute("id") === aw
				}
			}
		} else {
			aa.filter.ID = function(ax) {
				var aw = new g(["^", ax, "$"].join(""), "g");
				return function(az) {
					var ay = typeof az.getAttributeNode !== "undefined" && az.getAttributeNode("id");
					return ay && aw.test(ay.value)
				}
			}
		}
		aa.find.TAG = ad.getElementsByTagName ? function(aw, ax) {
			if (typeof ax.getElementsByTagName !== "undefined") {
				return ax.getElementsByTagName(aw)
			} else {
				if (ad.qsa) {
					return ax.querySelectorAll(aw)
				}
			}
		} : function(aw, aA) {
			var aB, az = [],
				ay = 0,
				ax = aA.getElementsByTagName(aw);
			if (aw === "*") {
				while ((aB = ax[ay++])) {
					if (aB.nodeType === 1) {
						az.push(aB)
		...
		aa.find.CLASS = ad.getElementsByClassName && function(ax, aw) {
			if (typeof aw.getElementsByClassName !== "undefined") {
				return aw.getElementsByClassName(ax)
			}
		};
		L = [];
		f = [];
		if ((ad.qsa = K.test(o.querySelectorAll))) {
			Y(function(aw) {
				p.appendChild(aw).innerHTML = "<a id='" + al + "'></a><select id='" + al + "-\r\\' msallowcapture=''><option selected=''></option></select>";
				if (aw.querySelectorAll("[msallowcapture^='']").length) {
					f.push("[*^$]=" + P + "*(?:''|\"\")")
				}
				if (!aw.querySelectorAll("[selected]").length) {
					f.push("\\[" + P + "*(?:value|" + af + ")")
				}
				if (!aw.querySelectorAll("[id~=" + al + "-]").length) {
					f.push("~=")
				}
				if (!aw.querySelectorAll(":checked").length) {
					f.push(":checked")
				}
			...
			Y(function(ax) {
				ax.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
				var aw = o.createElement("input");
				aw.setAttribute("type", "hidden");
				ax.appendChild(aw).setAttribute("name", "D");
				if (ax.querySelectorAll("[name=d]").length) {
					f.push("name" + P + "*[*^$|!~]?=")
				}
				if (ax.querySelectorAll(":enabled").length !== 2) {
					f.push(":enabled", ":disabled")
				}
				p.appendChild(ax).disabled = true;
				if (ax.querySelectorAll(":disabled").length !== 2) {
					f.push(":enabled", ":disabled")
				}
				ax.querySelectorAll("*,:x");
				f.push(",.*:")
			})
		}
		if ((ad.matchesSelector = K.test((b = p.matches || p.webkitMatchesSelector || p.mozMatchesSelector || p.oMatchesSelector || p.msMatchesSelector)))) {
			Y(function(aw) {
				ad.disconnectedMatch = b.call(aw, "*");
				b.call(aw, "[s!='']:x")
			})
		}
		f = f.length && new g(f.join("|"));
		L = L.length && new g(L.join("|"));
		e = K.test(p.compareDocumentPosition);
		R = e || K.test(p.contains) ? function(ax, aw) {
			var az = ax.nodeType === 9 ? ax.documentElement : ax,
				ay = aw && aw.parentNode;
			return ax === ay || !!(ay && ay.nodeType === 1 && (az.contains ? az.contains(ay) : ax.compareDocumentPosition && ax.compareDocumentPosition(ay) & 16))
		} : function(ax, aw) {
			if (aw) {
		...
		y = e ? function(ax, aw) {
			...
			var ay = !ax.compareDocumentPosition - !aw.compareDocumentPosition;
			if (ay) {
				return ay
			}
			ay = (ax.ownerDocument || ax) === (aw.ownerDocument || aw) ? ax.compareDocumentPosition(aw) : 1;
			if (ay & 1 || (!ad.sortDetached && aw.compareDocumentPosition(ax) === ay)) {
				if (ax === o || ax.ownerDocument === am && R(am, ax)) {
					return -1
				}
				if (aw === o || aw.ownerDocument === am && R(am, aw)) {
					return 1
				}
				return T ? (G(T, ax) - G(T, aw)) : 0
			}
			return ay & 4 ? -1 : 1
		} : function(ax, aw) {
			if (ax === aw) {
			...
			var aD, aA = 0,
				...
				aB = [aw];
			if (!aC || !az) {
				return ax === o ? -1 : aw === o ? 1 : aC ? -1 : az ? 1 : T ? (G(T, ax) - G(T, aw)) : 0
			} else {
				if (aC === az) {
					return j(ax, aw)
				}
			...
			return aA ? j(ay[aA], aB[aA]) : ay[aA] === am ? -1 : aB[aA] === am ? 1 : 0
		};
		return o
	};
	ae.matches = function(i, e) {
		return ae(i, null, null, e)
	};
	ae.matchesSelector = function(au, aw) {
		if ((au.ownerDocument || au) !== o) {
			u(au)
		}
		aw = aw.replace(E, "='$1']");
		if (ad.matchesSelector && !F[aw + " "] && (!L || !L.test(aw)) && (!f || !f.test(aw))) {
			try {
				var i = b.call(au, aw);
				if (i || ad.disconnectedMatch || au.document && au.document.nodeType !== 11) {
					return i
				}
			} catch (av) {}
		}
		return ae(aw, o, null, [au]).length > 0
	};
	ae.contains = function(e, i) {
	...
	ae.uniqueSort = function(av) {
		var aw, ax = [],
			e = 0,
			au = 0;
		r = !ad.detectDuplicates;
		T = !ad.sortStable && av.slice(0);
		av.sort(y);
		if (r) {
			while ((aw = av[au++])) {
				if (aw === av[au]) {
		...
		filter: {
			TAG: function(i) {
				...
				return i === "*" ? function() {
					...
					return au.nodeName && au.nodeName.toLowerCase() === e
				}
			},
			CLASS: function(e) {
				var i = ah[e + " "];
				return i || (i = new g("(^|" + P + ")" + e + "(" + P + "|$)")) && ah(e, function(au) {
					return i.test(typeof au.className === "string" && au.className || typeof au.getAttribute !== "undefined" && au.getAttribute("class") || "")
				})
			},
			ATTR: function(au, i, e) {
				return function(aw) {
					var av = ae.attr(aw, au);
					if (av == null) {
						return i === "!="
					}
					if (!i) {
					...
					av += "";
					return i === "=" ? av === e : i === "!=" ? av !== e : i === "^=" ? e && av.indexOf(e) === 0 : i === "*=" ? e && av.indexOf(e) > -1 : i === "$=" ? e && av.slice(-e.length) === e : i === "~=" ? (" " + av.replace(C, " ") + " ").indexOf(e) > -1 : i === "|=" ? av === e || av.slice(0, e.length + 1) === e + "-" : false
				}
			}
		}
	};
	...
	function B() {}
	B.prototype = aa.filters = aa.pseudos;
	aa.setFilters = new B();
	k = ae.tokenize = function(aw, aB) {
		var i, ax, az = [],
			aA, ay, au, e, av = ai[aw + " "];
		if (av) {
			return aB ? 0 : av.slice(0)
		}
		ay = aw;
		au = [];
		e = aa.preFilter;
		while (ay) {
			...
			if ((ax = W.exec(ay))) {
				...
				az.push({
					value: i,
					type: ax[0].replace(ag, " ")
				});
				ay = ay.slice(i.length)
			}
			for (aA in aa.filter) {
				if ((ax = V[aA].exec(ay)) && (!e[aA] || (ax = e[aA](ax)))) {
					i = ax.shift();
					az.push({
						value: i,
						type: aA,
		...
		return aB ? ay.length : ay ? ae.error(aw) : ai(aw, au).slice(0)
	};
	...
	function N(ay, aw, ax) {
		var e = aw.dir,
			...
			az = ax && au === "parentNode",
			i = x++;
		return aw.first ? function(aC, aB, aA) {
			while ((aC = aC[e])) {
				if (aC.nodeType === 1 || az) {
					return ay(aC, aB, aA)
				}
			...
			if (aC) {
				...
				while ((aF = aF[e])) {
					if (aF.nodeType === 1 || az) {
						aE = aF[al] || (aF[al] = {});
						aA = aE[aF.uniqueID] || (aE[aF.uniqueID] = {});
						if (av && av === aF.nodeName.toLowerCase()) {
							aF = aF[e] || aF
						} else {
							if ((aG = aA[au]) && aG[0] === J && aG[1] === i) {
								return (aB[2] = aG[2])
							} else {
								aA[au] = aB;
								if ((aB[2] = ay(aF, aD, aC))) {
	...
	function w(e) {
		return e.length > 1 ? function(ax, aw, au) {
			var av = e.length;
			while (av--) {
				if (!e[av](ax, aw, au)) {
					return false
	...
	function aq(au, i, aw, av, ax, e) {
		...
		return ao(function(aI, aF, aA, aH) {
			var aK, aG, aC, aB = [],
				aJ = [],
				az = aF.length,
				ay = aI || I(i || "*", aA.nodeType ? [aA] : aA, []),
				aD = au && (aI || !i) ? M(ay, aB, au, aA, aH) : ay,
				aE = aw ? ax || (aI ? au : az || av) ? [] : aF : aD;
			if (aw) {
				aw(aD, aE, aA, aH)
			}
			if (av) {
			...
			if (aI) {
				if (ax || au) {
					...
					aG = aE.length;
					while (aG--) {
						if ((aC = aE[aG]) && (aK = ax ? G(aI, aC) : aB[aG]) > -1) {
							aI[aK] = !(aF[aK] = aC)
						}
					}
				}
			} else {
				aE = M(aE === aF ? aE.splice(az, aE.length) : aE);
				if (ax) {
					ax(null, aF, aE, aH)
				} else {
					aj.apply(aF, aE)
	...
	function O(az) {
		var au, ax, av, ay = az.length,
			aC = aa.relative[az[0].type],
			aD = aC || aa.relative[" "],
			aw = aC ? 1 : 0,
			aA = N(function(i) {
				return i === au
			...
			e = [function(aG, aF, aE) {
				var i = (!aC && (aE || aF !== X)) || ((au = aF).nodeType ? aA(aG, aF, aE) : aB(aG, aF, aE));
				au = null;
				return i
			}];
		for (; aw < ay; aw++) {
			if ((ax = aa.relative[az[aw].type])) {
				e = [N(w(e), ax)]
			} else {
				ax = aa.filter[az[aw].type].apply(null, az[aw].matches);
				if (ax[al]) {
					av = ++aw;
					for (; av < ay; av++) {
						if (aa.relative[az[av].type]) {
							break
						}
					}
					return aq(aw > 1 && w(e), aw > 1 && a(az.slice(0, aw - 1).concat({
						value: az[aw - 2].type === " " ? "*" : ""
					})).replace(ag, "$1"), ax, aw < av && O(az.slice(aw, av)), av < ay && O((az = az.slice(av))), av < ay && a(az))
				}
				e.push(ax)
			}
		}
	...
	function n(av, au) {
		var e = au.length > 0,
			aw = av.length > 0,
			i = function(aG, aA, aF, aE, aJ) {
				var aB, aC, aH, aL = 0,
					aD = "0",
					ax = aG && [],
					aM = [],
					aK = X,
					az = aG || aw && aa.find.TAG("*", aJ),
					ay = (J += aK == null ? 1 : Math.random() || 0.1),
					aI = az.length;
				if (aJ) {
					X = aA === o || aA || aJ
				}
				for (; aD !== aI && (aB = az[aD]) != null; aD++) {
					if (aw && aB) {
						aC = 0;
						if (!aA && aB.ownerDocument !== o) {
							u(aB);
							aF = !an
						}
						while ((aH = av[aC++])) {
				...
				if (e && aD !== aL) {
					...
					aj.apply(aE, aM);
					if (aJ && !aG && aM.length > 0 && (aL + au.length) > 1) {
						ae.uniqueSort(aE)
					}
				}
				if (aJ) {
	...
	ak = ae.select = function(e, ay, ax, au) {
		var aw, az = typeof e === "function" && e,
			av = !au && k((e = az.selector || e));
		ax = ax || [];
		(az || t(e, av))(au, ay, !an, ax, !ay || ay);
		return ax
	};
	ad.sortStable = al.split("").sort(y).join("") === al;
	ad.detectDuplicates = !!r;
	u();
	ad.sortDetached = Y(function(e) {
	...
	if (!Y(function(e) {
		...
		z("type|href|height|width", function(i, e) {
			return i.getAttribute(e, e.toLowerCase() === "type" ? 1 : 2)
		})
	}
	if (!ad.attributes || !Y(function(e) {
			e.innerHTML = "<input/>";
			e.firstChild.setAttribute("value", "");
			return e.firstChild.getAttribute("value") === ""
		})) {
		z("value", function(i, e) {
	...
	if (!Y(function(e) {
		...
		z(af, function(i, e) {
			var au;
			return i[e] === true ? e.toLowerCase() : (au = i.getAttributeNode(e)) && au.specified ? au.value : null
		})
	}
	s.support = ad;
	s.all = ae
...
(function(l) {
	...
	var s = 20180115;
	if (l._dom_ver) {
		if (l.isNumber(l._dom_ver) && l._dom_ver >= s) {
			return
		}
	}
	l._dom_ver = s;
	...
	I = M.prototype = {
		...
		slice: function() {
			return new M(x.apply(this, arguments))
		},
		...
		each: function(aj, ai) {
			var ah = this;
			l.each(ah, function(al, ak) {
				al = new M(al);
				return aj.call(ai || al, al, ak, ah)
			});
			return ah
		},
		getEL: function() {
		...
		one: function(ah) {
			var ai = this,
				ak = ai.all(ah),
				aj = ak.length ? ak.slice(0, 1) : null;
			return aj
		}
	};
	l.mix(M, {
		all: function(ah, aj) {
			...
			if (typeof ah === "string") {
				if ((ah = l.trim(ah)) && ah.length >= 3 && l.startsWith(ah, "<") && l.endsWith(ah, ">")) {
					l.err("Err 4002.")
				}
				return new M(l.all(ah, ai))
			}
			if (ah.isNodeList) {
				return ah
			}
		...
		one: function(ah, ai) {
			var aj = M.all(ah, ai);
			return aj.length ? aj.slice(0, 1) : null
		}
	});
	l.one = M.one;
	var P = l.support,
		T = l.all;
	var d, V, X, L, v, m, O = document.createElement("div"),
		aa = document.createElement("div");
	if (!aa.style) {
		return
	}
	aa.style.cssText = "float:left;opacity:.5";
	P.opacity = aa.style.opacity === "0.5";
	P.cssFloat = !!aa.style.cssFloat;
	aa.style.backgroundClip = "content-box";
	aa.cloneNode(true).style.backgroundClip = "";
	P.clearCloneStyle = aa.style.backgroundClip === "content-box";
	O = document.createElement("div");
	O.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute";
	aa.innerHTML = "";
	O.appendChild(aa);
	P.boxSizing = aa.style.boxSizing === "" || aa.style.MozBoxSizing === "" || aa.style.WebkitBoxSizing === "";
	l.mix(P, {
	...
	function r() {
		var ai, ah;
		f.appendChild(O);
		aa.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%";
		d = X = m = false;
		V = v = true;
		if (window.getComputedStyle) {
			ah = window.getComputedStyle(aa);
			d = (ah || {}).top !== "1%";
			m = (ah || {}).marginLeft === "2px";
			X = (ah || {
				width: "4px"
			...
			ai = aa.appendChild(document.createElement("div"));
			ai.style.cssText = aa.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0";
			ai.style.marginRight = ai.style.width = "0";
			aa.style.width = "1px";
			v = !parseFloat((window.getComputedStyle(ai) || {}).marginRight);
			aa.removeChild(ai)
		}
		aa.style.display = "none";
		L = aa.getClientRects().length === 0;
		if (L) {
			aa.style.display = "";
			aa.innerHTML = "<table><tr><td></td><td>t</td></tr></table>";
			aa.childNodes[0].style.borderCollapse = "separate";
			ai = aa.getElementsByTagName("td");
			ai[0].style.cssText = "margin:0;border:0;padding:0;display:none";
			L = ai[0].offsetHeight === 0;
			if (L) {
				ai[0].style.display = "";
	...
	var k, i, B = (/^margin/),
		...
		ab = (/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/).source,
		N = new RegExp("^(" + ab + ")(?!px)[a-z%]+$", "i"),
		q = new RegExp("^(" + ab + ")(.*)$", "i");
	if (window.getComputedStyle) {
		k = function(aj) {
			var ai, ah;
			ai = l.isFunction(aj.getEL) ? aj.getEL() : aj;
			ah = ai.ownerDocument.defaultView;
			if (!ah || !ah.opener) {
				ah = window
			}
			return ah.getComputedStyle(ai)
		};
		i = function(ao, ai, an) {
			var al, ak, am, ah, aj = ao.style;
			an = an || k(ao);
			ah = an ? an.getPropertyValue(ai) || an[ai] : undefined;
			if ((ah === "" || ah === undefined) && !z.contains(ao.ownerDocument, ao)) {
				ah = z.style(ao, ai)
			}
			if (an) {
				if (!P.pixelMarginRight() && N.test(ah) && B.test(ai)) {
					al = aj.width;
					ak = aj.minWidth;
					am = aj.maxWidth;
					aj.minWidth = aj.maxWidth = aj.width = ah;
					ah = an.width;
					aj.width = al;
					aj.minWidth = ak;
					aj.maxWidth = am
			...
			return ah === undefined ? ah : ah + ""
		}
	} else {
		if (f.currentStyle) {
			k = function(ah) {
				return ah.currentStyle
			};
			i = function(an, ak, am) {
				var ao, ai, ah, aj, al = an.style;
				am = am || k(an);
				aj = am ? am[ak] : undefined;
				if (aj == null && al && al[ak]) {
					aj = al[ak]
				}
				if (N.test(aj) && !u.test(ak)) {
					ao = al.left;
					ai = an.runtimeStyle;
					ah = ai && ai.left;
					if (ah) {
						ai.left = an.currentStyle.left
					}
					al.left = ak === "fontSize" ? "1em" : aj;
					aj = al.pixelLeft + "px";
					al.left = ao;
					if (ah) {
						ai.left = ah
				...
				return aj === undefined ? aj : aj + "" || "auto"
			}
		}
	}
	...
	var z = {
		type: function(ah) {
			...
			return typeof ah === "object" || typeof ah === "function" ? class2type[toString.call(ah)] || "object" : typeof ah
		},
		cssHooks: {},
		htmlPrefilter: function(ah) {
			return ah.replace(g, "<$1></$2>")
		},
		nodeName: function(ai, ah) {
			return ai.nodeName && ai.nodeName.toLowerCase() === ah.toLowerCase()
		},
		merge: function(al, aj) {
			var ah = +aj.length,
				ai = 0,
				ak = al.length;
			while (ai < ah) {
		...
		camelCase: function(ah) {
			return ah.replace(J, "ms-").replace(C, E)
		},
		cssProps: {
	...
	function Q(ah) {
		...
		var aj = ah.charAt(0).toUpperCase() + ah.slice(1),
			ai = Z.length;
		while (ai--) {
			ah = Z[ai] + aj;
			if (ah in F) {
	...
	function o(ak, ah) {
		var ai, al, aj = 0,
			am = typeof ak.getElementsByTagName !== "undefined" ? ak.getElementsByTagName(ah || "*") : typeof ak.querySelectorAll !== "undefined" ? ak.querySelectorAll(ah || "*") : undefined;
		if (!am) {
			for (am = [], ai = ak.childNodes || ak;
				(al = ai[aj]) != null; aj++) {
				if (!ah || z.nodeName(al, ah)) {
					am.push(al)
				} else {
					z.merge(am, o(al, ah))
				}
		...
		return ah === undefined || ah && z.nodeName(ak, ah) ? z.merge([ak], am) : am
	}

	function j(ai, ak) {
		var ap, am, ao, ar, au, at, aj, an = ai.length,
			al = Y(ak),
			ah = [],
			aq = 0;
		for (; aq < an; aq++) {
			...
			if (am || am === 0) {
				if (l.type(am) === "object") {
					z.merge(ah, am.nodeType ? [am] : am)
				} else {
					if (!y.test(am)) {
						ah.push(ak.createTextNode(am))
					} else {
						ar = ar || al.appendChild(ak.createElement("div"));
						au = (p.exec(am) || ["", ""])[1].toLowerCase();
						aj = U[au] || U._default;
						ar.innerHTML = aj[1] + z.htmlPrefilter(am) + aj[2];
						ap = aj[0];
						while (ap--) {
							ar = ar.lastChild
						}
						if (!P.leadingWhitespace && e.test(am)) {
							ah.push(ak.createTextNode(e.exec(am)[0]))
						}
						if (!P.tbody) {
							am = au === "table" && !rtbody.test(am) ? ar.firstChild : aj[1] === "<table>" && !rtbody.test(am) ? ar : 0;
							ap = am && am.childNodes.length;
							while (ap--) {
								if (z.nodeName((at = am.childNodes[ap]), "tbody") && !at.childNodes.length) {
									am.removeChild(at)
								}
							}
						}
						z.merge(ah, ar.childNodes);
						ar.textContent = "";
						while (ar.firstChild) {
		...
		aq = 0;
		while ((am = ah[aq++])) {
			ao = T.contains(am.ownerDocument, am);
			ar = o(al.appendChild(am), "script");
			if (ao) {
				setGlobalEval(ar)
			}
		}
	...
	function Y(aj) {
		var ai = K.split("|"),
			ah = aj.createDocumentFragment();
		if (ah.createElement) {
			while (ai.length) {
				ah.createElement(ai.pop())
			}
		}
		return ah
	}
	var H = function(am, al, an, ak) {
		var aj, ai, ah = {};
		for (ai in al) {
			ah[ai] = am.style[ai];
			am.style[ai] = al[ai]
	...
	function af(al, ai, ah) {
		var ak = true,
			am = ai === "width" ? al.offsetWidth : al.offsetHeight,
			aj = k(al),
			an = P.boxSizing && z.css(al, "boxSizing", false, aj) === "border-box";
		if (am <= 0 || am == null) {
			am = i(al, ai, aj);
			if (am < 0 || am == null) {
				am = al.style[ai]
			...
			ak = an && (P.boxSizingReliable() || am === al.style[ai]);
			am = parseFloat(am) || 0
		}
		return (am + w(al, ai, ah || (an ? "border" : "content"), ak, aj))
	}

	function w(al, ai, ah, an, ak) {
		var aj = ah === (an ? "border" : "content") ? 4 : ai === "width" ? 1 : 0,
			am = 0;
		for (; aj < 4; aj += 2) {
			if (ah === "margin") {
				am += z.css(al, ah + b[aj], true, ak)
			}
			if (an) {
				if (ah === "content") {
					am -= z.css(al, "padding" + b[aj], true, ak)
				}
				if (ah !== "margin") {
					am -= z.css(al, "border" + b[aj] + "Width", true, ak)
				}
			} else {
				am += z.css(al, "padding" + b[aj], true, ak);
				if (ah !== "padding") {
	...
	function S(ah) {
		var ai = new RegExp("^(?:([+-])=|)(" + ab + ")([a-z%]*)$", "i");
		return ai.exec(ah)
	}

	function A(ah, aj, ak) {
		var ai = q.exec(aj);
		return ai ? Math.max(0, ai[1] - (ak || 0)) + (ai[2] || "px") : aj
	}

	function n(ai, ah, al, aq) {
		var ar, aj = 1,
			an = 20,
			ap = aq ? function() {
				return aq.cur()
			...
			am = ap(),
			ao = al && al[3] || (z.cssNumber[ah] ? "" : "px"),
			ak = (z.cssNumber[ah] || ao !== "px" && +am) && S(z.css(ai, ah));
		if (ak && ak[3] !== ao) {
			ao = ao || ak[3];
			al = al || [];
			ak = +am || 1;
			do {
				...
				ak = ak / aj;
				z.style(ai, ah, ak + ao)
			} while (aj !== (aj = ap() / am) && aj !== 1 && --an)
		}
		if (al) {
			ak = +ak || +am || 0;
			ar = al[1] ? ak + (al[1] + 1) * al[2] : +al[2];
			if (aq) {
				aq.unit = ao;
				aq.start = ak;
				aq.end = ar
	...
	l.each(["height", "width"], function(ah, ai) {
		z.cssHooks[ah] = {
			get: function(al, ak, aj) {
				if (ak) {
					return D.test(z.css(al, "display")) && al.offsetWidth === 0 ? H(al, cssShow, function() {
						return af(al, ah, aj)
					}) : af(al, ah, aj)
				}
			},
			set: function(al, am, aj) {
				var ak = aj && k(al);
				return A(al, am, aj ? w(al, ah, aj, P.boxSizing && z.css(al, "boxSizing", false, ak) === "border-box", ak) : 0)
			}
		}
	});
	l.style = z.style = function(aj, ai, ao, ak) {
		if (!aj || aj.nodeType === 3 || aj.nodeType === 8 || !aj.style) {
			return
		}
		var am, an, ap, al = z.camelCase(ai),
			ah = aj.style;
		ai = z.cssProps[al] || (z.cssProps[al] = Q(al) || al);
		ap = z.cssHooks[ai] || z.cssHooks[al];
		if (ao !== undefined) {
			an = typeof ao;
			if (an === "string" && (am = S(ao)) && am[1]) {
				ao = n(aj, ai, am);
				an = "number"
			}
			if (ao == null || ao !== ao) {
			...
			if (an === "number") {
				ao += am && am[3] || (z.cssNumber[al] ? "" : "px")
			}
			if (!P.clearCloneStyle && ao === "" && ai.indexOf("background") === 0) {
				ah[ai] = "inherit"
			}
			if (!ap || !("set" in ap) || (ao = ap.set(aj, ao, ak)) !== undefined) {
				ah[ai] = ao
			}
		} else {
			if (ap && "get" in ap && (am = ap.get(aj, false, ak)) !== undefined) {
				return am
			}
			return ah[ai]
		}
	};
	l.css = z.css = function(an, al, ai, am) {
		var ak, ao, ah, aj = z.camelCase(al);
		al = z.cssProps[aj] || (z.cssProps[aj] = Q(aj) || aj);
		ah = z.cssHooks[al] || z.cssHooks[aj];
		if (ah && "get" in ah) {
			ao = ah.get(an, true, ai)
		}
		if (ao === undefined) {
			ao = i(an, al, am)
		}
		if (ao === "normal" && al in cssNormalTransform) {
			ao = cssNormalTransform[al]
		}
		if (ai === "" || ai) {
			ak = parseFloat(ao);
			return ai === true || isFinite(ak) ? ak || 0 : ao
		}
		return ao
	};
	var a = " ",
		...
		G = function(al, an) {
			...
			if (aj && ah) {
				...
				for (; ai < ah; ai++) {
					am = a + an[ai] + a;
					while (ak.indexOf(am) >= 0) {
						ak = ak.replace(am, a)
					}
				}
				al.className = l.trim(ak)
			}
		};
	l.mix(I, {
		before: function(ai) {
			var aj = this.getEL(),
				ah = ai;
			if (typeof ai === "string" && (ai = l.trim(ai)) && ai.length >= 3 && l.startsWith(ai, "<") && l.endsWith(ai, ">")) {
				ah = l.parseHTML(ai)[0]
			}
			aj.insertBefore(ah, aj.childNodes[0])
		},
		append: function(ai) {
			var aj = this.getEL(),
				ah = ai;
		...
		style: function(aj, ah) {
			var ai = this.getEL();
			return z.style(ai, aj, ah)
		},
		css: function(ah) {
			var ai = this.getEL();
			l.each(ah, function(aj, ak) {
				z.style(ai, ak, aj)
			})
		},
	...
	l.parseHTML = function(aj, ai) {
		...
		var ah = R.exec(aj);
		if (ah) {
			return [ai.createElement(ah[1])]
		}
		ah = j([aj], ai);
		return z.merge([], ah.childNodes)
	}
})(dynamsoft.lib);
(function(d) {
	...
	var e = 20180115;
	if (d._polyfill_ver) {
		if (d.isNumber(d._polyfill_ver) && d._polyfill_ver >= e) {
			return
		}
	}
	d._polyfill_ver = e;
	if (!d.isFunction(b.indexOf)) {
		b.indexOf = function(h, i) {
			var g;
			if (this == null) {
				return -1
			}
			...
			g = Math.max(l >= 0 ? l : f - Math.abs(l), 0);
			while (g < f) {
				if (g in j && j[g] === h) {
					return g
				}
	...
	if (!d.isFunction(a.bind)) {
		a.bind = function(h) {
			...
			if (1 < arguments.length) {
				var f = b.slice.call(arguments, 1);
				return function() {
					return g.apply(h, arguments.length ? f.concat(b.slice.call(arguments)) : f)
				}
			}
			return function() {
				return arguments.length ? g.apply(h, arguments) : g.call(h)
			}
		}
	}
...
(function(a) {
	...
	var i = 20180115;
	if (e._event_ver) {
		if (e.isNumber(e._event_ver) && e._event_ver >= i) {
			return
		}
	}
	e._event_ver = i;
	f = function(l) {
		var k = l;
		if (k == "mousewheel") {
			k = d.bGecko ? "DOMMouseScroll" : "mousewheel"
		}
		return k
	};
	h = {
		addEventListener: g.addEventListener ? function(l, n, m) {
			var k = f(n);
			if (l) {
		...
		removeEventListener: g.removeEventListener ? function(l, n, m) {
			var k = f(n);
			if (l) {
		...
		getWheelDelta: function(k) {
			k = k || window.event;
			var n, m = k.wheelDelta,
				l = k.detail;
			if (m) {
				n = m / 120
			}
	...
	var j = function(k) {
		...
		var l = true;
		e.each(e.Events.registedObjs, function(n) {
			e.each(e.Events.registedClass, function(o) {
				if (n instanceof o) {
					if (n.bFocus && n.handlerKeyDown) {
						l = n.handlerKeyDown(m);
						if (!l) {
							return false
						}
					}
	...
	e.addEventListener(document.documentElement, "keydown", j);
	...
	e.EnumMouseButton = b;
	e.detectButton = function(k) {
		var l = k || window.event;
		if (l.which == null) {
			return (l.button < 2) ? b.LEFT : ((l.button == 4) ? b.MIDDLE : b.RIGHT)
		} else {
			return (l.which < 2) ? b.LEFT : ((l.which == 2) ? b.MIDDLE : b.RIGHT)
		}
	};
	e.fireEvent = function(k, l) {
		var m;
		if (g.createEvent) {
			m = g.createEvent("HTMLEvents");
...
(function(t, f, p) {
	var m = window,
		j = /^(?:about|app|app\-storage|.+\-extension|file|widget)$/,
		x = 1,
		E = 2,
		e = 3,
		I = 200,
		...
		v = 500,
		F = -1022,
		H = "The local service (Dynamsoft Service) is disconnected.",
		z = "open error: ",
		w = "send error: ",
		h = new t.Uri(location.href),
		D = h && j.test(h.getScheme()),
		G = false,
		k = function() {
			try {
		...
		y = function() {
			try {
				var K = false;
				t.each(["Msxml2.XMLHTTP.6.0", "Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.3.0", "Msxml3.XMLHTTP"], function(M) {
					try {
						return (K = new m.ActiveXObject(M))
					} catch (N) {
						t.error("new xhr error: " + N.message)
					}
				});
				return K
			} catch (L) {}
		...
		s = (!D && m.XMLHttpRequest) ? ("withCredentials" in (k() || [])) : false,
		C = m.ActiveXObject ? function(K) {
			if (f.bIE && (parseInt(f.strBrowserVersion) <= 9)) {
				return y()
			}
			if (!s && K && G) {
				return new G
		...
		B = t.nil,
		l, d;
	if (f.bIE && parseInt(f.strBrowserVersion) <= 10) {
		B = t.noop
	}
	l = {
		...
		getAllResponseHeaders: function() {
			var K = this;
			return K.state === E ? K.responseHeadersString : null
		},
		...
		getResponseHeader: function(M) {
			...
			M = M.toLowerCase();
			if (K.state === E) {
				if (!(N = K.responseHeaders)) {
					N = K.responseHeaders = {};
					while (L = a.exec(K.responseHeadersString)) {
						N[L[1].toLowerCase()] = L[2]
					}
				}
				L = N[M]
			}
		...
		_ioReady: function(L, O) {
			var M = this,
				K;
			if (M.state === E || M.state === e) {
				return
			}
			if (M.state === x) {
				M.state = E
			...
			try {
				if (L >= I) {
					M.handleResponseData()
				}
			} catch (N) {
				t.error(N.stack || N, "error");
				O = N.message || "parser error"
			}
			M.status = L;
			M.statusText = O;
			M._callback(K)
		},
		_callback: function(K) {
			var M = this,
				R = M.statusText,
				Q;
			if (Q = M.timeoutTimer) {
			...
			var P = K ? "onSuccess" : "onError",
				O, L = [M.responseData, R, M],
				N = M.context;
			O = M[P];
			if (t.isFunction(O)) {
				O.apply(N, L)
		...
		handleResponseData: function() {
			var M = this,
				K, L = M.dataType,
				O = M.nativeXhr;
			if (L === "blob" || L === "arraybuffer") {
				K = !!m.Blob ? O.response : O.responseBody
			} else {
				if (L == "json") {
					if (O.responseType && O.responseType.toLowerCase() == "json") {
						K = O.response
					} else {
						K = O.responseText ? ((m.JSON && m.JSON.parse) ? m.JSON.parse(O.responseText) : t.parse(O.responseText)) : {}
					}
				} else {
					if (L === "user-defined") {
						K = O.response !== p ? O.response : O.responseText
					} else {
						M.responseText = K = O.responseText || "";
						try {
							var N = O.responseXML;
		...
		sendInternal: function() {
			...
			try {
				Z.state = x;
				if (V.username) {
					W.open(L, M, V.async, V.username, V.password)
				} else {
					W.open(L, M, V.async)
				}
				if ((V.async || f.bIE) && Y && Y != "user-defined" && ("responseType" in W)) {
					try {
						W.responseType = Y
					} catch (T) {}
				}
				...
				if (Z.state < 2) {
					t.error(U.stack || U, "error");
					Z._ioReady(-1, z + (t.isNumber(U.number) ? "(" + U.number + ")" : "") + (U.message || ""))
				} else {
					t.error(U)
				}
				return
			...
			if (N && W.overrideMimeType) {
				W.overrideMimeType(N)
			}
			S = V.headers || {};
			var O = S["X-Requested-With"];
			if (O === false) {
				delete S["X-Requested-With"]
			}
			if (typeof W.setRequestHeader !== "undefined") {
				if (V.contentType) {
					W.setRequestHeader("Content-Type", V.contentType)
				}
				W.setRequestHeader("Accept", Y && J[Y] ? J[Y] + (Y === "*" ? "" : ", */*; q=0.01") : J["*"]);
				for (R in S) {
					W.setRequestHeader(R, S[R])
				}
			}
			Q = !n.test(V.method);
			P = Q && V.data || null;
			if (Q && f.bIE && parseInt(f.strBrowserVersion) < 10) {
				P = V.data
			}
			if (V.async && V.timeout > 0) {
				Z.timeoutTimer = setTimeout(function() {
					Z.abort("timeout")
				}, V.timeout * 1000)
			}
			try {
				Z.state = x;
				if (t.isFunction(Z.beforeSend)) {
					var K = Z.beforeSend(W, Z);
					if (K === false) {
						Z.abort("cancel");
						return
					}
				...
				P = null;
				V.data = null;
				if (t.isFunction(Z.afterSend)) {
					Z.afterSend(Z)
				}
			} catch (T) {
				if (Z.state < 2) {
					t.error(T.stack || T, "error");
					Z._ioReady(-1, w + (T.message || ""))
				} else {
					t.error(T)
				}
			}
			if (!V.async || W.readyState === 4) {
				Z._xhrCallback()
			} else {
				if (q(W)) {
					W.onload = function() {
			...
			try {
				if (N.readyState === 4 || Q) {
					...
					if (Q) {
						...
						if (!q(N)) {
							M.responseHeadersString = N.getAllResponseHeaders()
						}
						var K = N.status,
							P;
						try {
				...
				N.onreadystatechange = B;
				if (!Q) {
					M._ioReady(-1, O.message || "process error")
				}
			}
		},
		_setupCfg: function(O) {
			var L = this,
				K, N, Q, M, P;
			M = O.url;
			if (t.startsWith(M, "http://") || t.startsWith(M, "https://")) {
				P = new t.Uri(M)
			} else {
				if (t.startsWith(M, "//")) {
					O.url = M = "http:" + M
			...
			if (!("crossDomain" in O)) {
				O.crossDomain = !P.isSameOriginAs(h)
			}
			Q = O.headers;
			for (N in Q) {
				if (t.isUndefined(Q[N])) {
					delete Q[N]
				}
			}
			t.mix(L, O);
	...
	r._strOpenErr = z;
	r._strSendErr = w;
	r._strConnectionToServiceLostString = H;
	d = {
		ajax: r,
		io: {
			get: function(L, M, N, K) {
				return new r({
					method: "GET",
					url: L,
					onSuccess: M,
...
(function(i) {
	var m = 20180115;
	if (i._json_ver) {
		if (i.isNumber(i._json_ver) && i._json_ver >= m) {
			return
		}
	}
	i._json_ver = m;
	...
	function j(r, q, u, s, v, p, o) {
		...
		switch (typeof t) {
			...
			case "object":
				...
				return g(t, u, s, v, p, o)
		}
		return undefined
	}

	function g(F, z, r, E, D, t) {
		var u = t;
		t += E;
		var v, q, x, s;
		if (r !== undefined) {
	...
	a.prototype = {
		...
		lex: function() {
			...
			i.error("lex error at line " + y.lineNumber + ":\n" + y.showDebugInfo());
			return undefined
		}
	};
	a.STATIC = {
	...
	d.parse = function h(y) {
		...
		while (1) {
			...
			if (!F) {
				i.log("it is not a valid input: " + y, "error");
				return false
			}
			E = s[t] && s[t][F];
			if (!E) {
	...
	i.parse = function(s, o) {
		var r = window,
			q = r.JSON;
		if (q && q.parse) {
			return q.parse(String(s))
		}
		var p = d.parse(String(s));
		if (o) {
			return k({
				"": p
			}, "", o)
...
(function(j, e) {
	var h = 20180115;
	if (j._dialog_ver) {
		if (j.isNumber(j._dialog_ver) && j._dialog_ver >= h) {
			return
		}
	}
	j._dialog_ver = h;
		...
		if (y) {
			...
			if (k) {
				...
				z._resizeFn = function() {
					var E = g ? s.body : s.documentElement,
						C = E.clientWidth + "px",
						D = E.clientHeight + "px",
						A = m.dm.overlay,
						B = z._dlgInfo.mask;
	...
	m.closeDialog = function(t) {
		...
		if (k) {
			var u = g ? s.body : s.documentElement;
		...
		if (v._dlgInfo.modal) {
			...
			m.dm.removeDialog(this)
		}
		return v.returnValue
	};
	m.createMouseEvent = function(u) {
...
(function(g, d, b) {
	...
	d.resourcesPath = d.resourcesPath || "Resources";
	...
	dynamsoft.dcp = e = {
		...
		managerVersion: [13, 3, 0, "0115"],
		serviceVersion: [1, 3, 0, "0115"],
		detect: a,
		versionInfo: function(n) {
			var m = 0,
				k = function(o) {
					if (g.isArray(o) && o.length > 1 && o[0] && o[1]) {
						a.curPort = e.ports[m % e.ports.length];
						var p = o[0].split(","),
							q = o[1].toLowerCase();
						if (e._compareVersion(p, e.oldDWASMVer)) {
							a.bConnected = true;
							a.dcpStatus = a.EnumDCP_DetectStatus.Connected;
							e._sendStatusEvent(false, o[0]);
							if (g.isFunction(n)) {
								setTimeout(n, 0)
							}
							return true
				...
				l = function(p, q, o) {
					++m;
					a.curPortIndex = m % e.ports.length;
					a.bConnected = false;
					if (a.bConnectNumLimited && m >= a.IMAXCONNECTCOUNT) {
						setTimeout(function() {
							n(p, q, o)
						}, 0);
						return true
			...
			this._postBase("VersionInfo", true, k, l)
		},
		_checkOldManagerVersion: function(l, k) {
			a.dcpStatus = a.EnumDCP_DetectStatus.CheckingManagerVer;
			this._postBase("VersionInfo", true, l, k)
		},
		_checkManagerVersion: function(l, k) {
			a.dcpStatus = a.EnumDCP_DetectStatus.CheckingManagerVer;
			this._postBase("VersionInfo", false, l, k)
		},
		_checkService: function(l, k) {
			a.dcpStatus = a.EnumDCP_DetectStatus.CheckingServiceVer;
			this._postBase("DSVersion", false, l, k)
		},
		_checkUpdateFile: function(l, k) {
			this._postBase("CheckUpdateFile", false, l, k)
		},
		_updateService: function(l, k) {
			this._postBase("UpdateService", false, l, k)
		},
		_postBase: function(l, p, n, m) {
			var o, q, k;
			if (!g.isFunction(n) || !g.isFunction(m)) {
				return
			}
			o = function(u, s) {
				var r = [e._getPreUrl(a.curPortIndex), p ? "dcp/" : e._getModuleName(), p ? e.oldDWASMVerStr : e._getModuleVer(), "/", l, "?type=1&dsver=", e.serviceVersion.join(""), "&ts=", g.now()].join(""),
					t, v;
				if (p) {
					v = e.oldDWASMVerStr
				} else {
					v = "dwasm2_" + e._getModuleVer()
				}
				t = g.stringify({
					id: "1",
					method: l,
		...
		loadZip: function(k, n, m, o) {
			var l;
			if (dynamsoft.managerEnv.IfUpdateService) {
				l = [e._getPreUrl(a.curPortIndex), e._getModuleName(), e._getModuleVer(), "/LoadZipFromBytes?type=", n, "&dsver=", e.serviceVersion.join(""), "&ts=", g.now()].join("")
			} else {
				l = [e._getPreUrl(a.curPortIndex), "dcp/", e.oldDWASMVerStr, "/LoadZipFromBytes?type=0", "&dsver=", e.serviceVersion.join(""), "&ts=", g.now()].join("")
			}
			new g.ajax({
				method: "POST",
				url: l,
		...
		oldLoadZip: function(l, k, n, o) {
			var m = [e._getPreUrl(a.curPortIndex), "dcp/", e.oldDWASMVerStr, "/LoadZipFromBytes?type=0", "&dsver=", e.serviceVersion.join(""), "&ts=", g.now()].join("");
			new g.ajax({
				method: "POST",
				url: m,
				async: true,
		...
		_getDSUpdateZipUrl: function() {
			...
			return [dynamsoft.managerEnv.resourcesPath, "/", m, "DSUpdate_", e.managerVersion.join("."), ".zip", k].join("")
		},
		checkDcpForUpdate: function(p, k, r, s, n, m, B) {
			var q = false,
				D = true,
				z = 3,
				l = 0,
				w = function(G) {
					...
					if (!dynamsoft.managerEnv.IfUpdateService) {
						...
						if (e._compareVersion(H, e.oldDWASMVer)) {
							var F = e._getDSUpdateZipUrl();
							q = true;
							var J = function(K) {
									a.dcpStatus = a.EnumDCP_DetectStatus.DownloadedZip;
									e._sendStatusEvent();
									var L = 0;
									e.oldLoadZip(K, L, function() {
										setTimeout(function() {
											e._checkManagerVersion(t, o)
										}, 5000)
									}, I)
								},
								I = function(L, M, K) {
									e._funUpdateFailed(n, m, L, K.status);
									setTimeout(B, 0)
								},
								E = function(L, N, K) {
									...
									if (O == 200) {
										...
										M = "The update package can't be downloaded. The error code is " + O + "."
									}
									m && m(true, M);
									e._sendStatusEvent(true, M);
									setTimeout(B, 0)
								};
							r && r();
							s && s();
				...
				u = function(E, F) {
					++l;
					a.curPortIndex = l % e.ports.length;
					a.bConnected = false;
					if (a.bConnectNumLimited && l >= a.IMAXCONNECTCOUNT) {
						...
						setTimeout(function() {
							e._checkOldManagerVersion(w, u)
						}, 1000)
					}
					return true
				},
				t = function(E) {
					if (!(g.isArray(E) && E.length > 0 && E[0])) {
						return false
					}
					var F = E[0].split(",");
					if (e._compareVersion(F, e.managerVersion)) {
						if (dynamsoft.managerEnv.IfUpdateService) {
							if (q) {
								setTimeout(function() {
									e._checkUpdateZip(s, n, m, B)
								}, 0)
							} else {
								setTimeout(function() {
									e._checkService(C, v)
				...
				o = function(G, H, F) {
					...
					z--;
					if (z < 0) {
						e._funShowUpgradeDialogWhenUpdateFailed(n, m);
						setTimeout(B, 0)
					} else {
						setTimeout(function() {
							e._checkManagerVersion(t, o)
				...
				C = function(F) {
					...
					var E = F[0].split(",");
					if (e._compareVersion(E, e.serviceVersion)) {
						a.bConnected = true;
						n && n();
						a.dcpStatus = a.EnumDCP_DetectStatus.CheckedService;
						e._sendStatusEvent(false, F[0]);
				...
				v = function(F, G, E) {
					e._funUpdateFailed(n, m, F, E.status);
					setTimeout(B, 0);
					return true
				};
			var y = false,
				A = function(E) {
					...
					var F = E[0].split(",");
					if (e._compareVersion(F, e.oldDWASMVer)) {
						y = true;
						a.curPort = e.ports[l % e.ports.length];
						if (!dynamsoft.managerEnv.IfUpdateService) {
							a.dcpStatus = a.EnumDCP_DetectStatus.UpdateSkipped;
							r && r();
							e._sendStatusEvent();
		...
		_checkUpdateZip: function(o, u, n, v) {
			var p = function(z, A, y) {
					var B = -1;
					if (y) {
						B = y.status
					}
				...
				s = function(y, A, x) {
					...
					if (B == 200) {
						...
						z = "The update package can't be downloaded. The error code is " + B + "."
					}
					n && n(true, z);
					e._sendStatusEvent(true, z);
					setTimeout(v, 0);
					return true
				},
				r = function(y) {
					if (!(g.isArray(y) && y.length > 1)) {
						return false
					}
					if (y[1] == true) {
				...
				k = function(x) {
					var y = 1;
					dynamsoft.dcp.loadZip(x, y, function(z) {
						var B, A;
						try {
							if (g.isString(z)) {
								A = g.parse(z.replace(/\0/g, ""));
								if ("result" in A) {
									B = A.result
								}
							}
						} catch (C) {}
						if (g.isArray(B) && B.length > 2 && B[2] == true) {
							setTimeout(function() {
								e._checkService(t, q)
							}, 5000);
							return
						}
						e._funUpdateFailed(u, n, z, 200);
						setTimeout(v, 0)
					}, m)
				},
				m = function(y, z, x) {
					...
					if (A == 0) {
						...
						e._funUpdateFailed(u, n, y, x.status);
						setTimeout(v, 0)
					}
					return true
				},
				w = function(x) {
					if (!(g.isArray(x) && x.length > 0)) {
						return false
					}
					if (x[0] == true) {
						setTimeout(function() {
				...
				l = 3,
				t = function(y) {
					if (!(g.isArray(y) && y.length > 0 && y[0])) {
						return false
					}
					var x = y[0].split(",");
					if (e._compareVersion(x, e.serviceVersion)) {
						a.bConnected = true;
						u && u();
						a.dcpStatus = a.EnumDCP_DetectStatus.CheckedService;
						e._sendStatusEvent(false, y[0]);
						a.dcpStatus = a.EnumDCP_DetectStatus.UpdateSucceed;
						e._sendStatusEvent();
						setTimeout(v, 0);
						return true
				...
				q = function(y, z) {
					...
					l--;
					if (l < 0) {
						e._funShowUpgradeDialogWhenUpdateFailed(u, n);
						setTimeout(v, 0);
						return true
					}
					setTimeout(function() {
		...
		_sendStatusEvent: function(l, m) {
			var k = l ? true : false;
			if (g.isFunction(i.OnGetServiceUpdateStatus)) {
				i.OnGetServiceUpdateStatus(k, a.dcpStatus, e._getStatusString(a.dcpStatus, m))
			}
		},
		_getErr: function(l) {
			var m, k = "";
		...
		_funUpdateFailed: function(l, k, m, p) {
			...
			if (p == 200) {
				n = "The update failed.";
				o = e._getStatusString(a.dcpStatus, e._getErr(m))
			} else {
				n = "The update failed. The error code is " + p;
				o = n
			}
			k && k(true, n);
			e._sendStatusEvent(true, o);
			return true
		}
	};
	j = b;
	h = b;
	d = b
})(dynamsoft.lib, dynamsoft.managerEnv);
(function(h) {
	var b = "",
		f = "[bio]: ",
		c = !0,
...
(function(a) {
	...
	Dynamsoft.WebTwainEnv = {
		JSVersion: "13.3.0.0115",
		ServerVersionInfo: "13,3,0,0115",
		ActiveXVersion: "12,3,0,0",
		...
		ProductKey: "",
		Trial: true,
		ResourcesPath: "https://https://dabresaad-alt.github.io/dynamsoft-webtwain-resource/",
		Debug: false,
...
(function(n, j, b) {
	...
	a.isLocalIP = function(B) {
		return B && (B === "127.0.0.1" || B === "localhost" || B === "local.dynamsoft.com")
	};
	n.mix(n, a);
	n.Addon_Events = [];
...
Dynamsoft.Lib.ready(function() {
	...
	Dynamsoft.Lib.install._strDynamsoftWithClose = ['<div class="dynamsoft-dwt-dlg-header">', '<div class="dynamsoft-dialog-close"></div>', "</div>"].join("");
	Dynamsoft.Lib.install._strDynamsoftWithoutClose = ['<div style="height:40px;"></div>'].join("");
...
Dynamsoft.WebTwainEnv.CloseDialog = function() {
	var a = Dynamsoft.Lib,
		d = a.install._dlgInstall;
	if (d) {
		var c = a.all(".dynamsoft-dialog-close");
		a.each(c, function(e, f) {
			a.removeEventListener(e, "click", DCP_DWT_OnClickCloseInstall)
		});
		if (d.open) {
			d.close()
		}
		if (a.install._dlgFromImageEditor) {
			var b = a.one(".D_ImageUIEditor")[0].parentNode;
			b.removeChild(d)
		} else {
...
Dynamsoft.WebTwainEnv.ShowDialog = function(g, j, k, a, h) {
	var b = Dynamsoft.Lib,
		e = b.install,
		n;
	if (!b.get("dynamsoft_waiting")) {
		...
		c.style.width = "100%";
		n = ['<div id="dynamsoft_waiting" class="dynamsoft-dialog dynamsoft-dialog2">', '<div id="', e._divInstallBody, '"></div></div>'];
		c.innerHTML = n.join("");
		if (a) {
	...
	var i = Dynamsoft.Lib.one(".dynamsoft-dialog");
	if (i && i[0]) {
		i[0].style.width = g + "px";
		if (j && j > 0) {
			i[0].style.height = j + "px"
		}
	}
	if (a) {
		b.get(e._divInstallBody).innerHTML = ['<div class="dynamsoft-dwt-dialog-body">', k, "</div>"].join("")
	} else {
		var l = (h ? e._strDynamsoftWithoutClose : e._strDynamsoftWithClose);
		b.get(e._divInstallBody).innerHTML = ['<div class="dynamsoft-dwt-dialog-body">', l, k, "</div>"].join("")
	}
	...
	var f = b.all(".dynamsoft-dialog-close");
	b.each(f, function(p, q) {
		b.addEventListener(p, "click", DCP_DWT_OnClickCloseInstall)
	})
};
...
(function() {
	Dynamsoft.Lib.Errors = {
		...
		LicenseExpired: function(b, a) {
			...
			b._errorString = "The current product key has expired on " + c + ", please contact the site administrator."
		},
...
(function(a) {
	...
	j = a.html5.Funs = {
		...
		init: function(o, z) {
			var l, m, v, k, s, r, u, y, n;
			y = [];
			y.push('<dialog class="dynamsoft-dwt-dialogProgress" style="top:30%"><h3 class="dynamsoft-finalMessage"></h3><p class="dynamsoft-status">0%</p>');
			if (a.env.bIE) {
				y.push('<div class="dynamsoft-progressBar" value="" max="100"></div>')
			} else {
				y.push('<progress class="dynamsoft-progressBar" value="" max="100"></progress>')
			}
			y.push('<br /><button class="dynamsoft-btnCancel" value="cancel" autofcus >cancel</button></dialog>');
			n = '<div class="dynamsoft-dwt-container-box"></div>';
			m = a.one("#" + z);
			m.html("");
			m.attr("class", o.containerClass);
			m.append(n);
			r = m.one(".dynamsoft-dwt-container-box");
			if (r) {
				r.style("position", "relative");
				j.changeImageUISize(o, o._width, o._height)
			}
			if (!a.dlgProgress) {
				s = a.one(".dynamsoft-dwt-dialogProgress");
				if (s) {
					s.remove()
				}
				var q = a.parseHTML(y.join(""));
				if (q && q.length > 0) {
					document.body.appendChild(q[0])
				}
				if (a.env.bIE) {
					var w = a.one(".dynamsoft-progressBar"),
						x = w && w[0];
					if (x) {
						x.objProgressBar = new a.ProgressBar(x, {
							width: 300,
							height: 20
						})
					}
				...
				if (p) {
					a.addEventListener(p[0], "mousedown", t)
				}
			}
			j.initImageUI(o, r)
		},
		initImageUI: function(o, q) {
			var l, k, m = o._width,
				p = o._height,
				n = f;
			l = a.one("#" + o._strDWTControlContainerID);
			...
			if (a.isString(p) && p.indexOf("%") >= 0) {
				p = a.css(l, "height") * parseInt(p) / 100;
				n = d
			} else {
				p = parseInt(p)
			}
			...
			j.bindUIViewEvents(o, k);
			o._UIManager = new a.UI.ImageUIManager(o, k);
			if (n) {
				j.changeImageUISize(o, o._width, o._height)
			}
		},
		changeImageUISize: function(o, n, p) {
			var l, m, t = -1,
				w = -1,
				k = n,
				v = p,
			...
			if (a.isString(n) && n.indexOf("%") >= 0) {
				u = a.css(l, "width") * parseInt(n) / 100;
				s = d
			} else {
				u = parseInt(n);
				k = [u + 2, "px"].join("")
			...
			if (s) {
				if (!o.__funResize) {
					o.__funResize = function() {
						var x = j.__innerGetUIViewRealSize(o._strDWTControlContainerID, o._width, o._height);
						if (o._UIManager) {
							return o._UIManager.ChangeSize(x.width, x.height)
						}
						return d
					}
				}
				a.removeEventListener(window, "resize", o.__funResize);
				a.addEventListener(window, "resize", o.__funResize)
			} else {
				if (o.__funResize) {
					a.removeEventListener(window, "resize", o.__funResize);
					o.__funResize = f
			...
			var r = j.__innerGetUIViewRealSize(o._strDWTControlContainerID, u, q);
			if (o._UIManager) {
				return o._UIManager.ChangeSize(r.width, r.height)
			}
			return d
		},
		__innerGetUIViewRealSize: function(m, k, o) {
			var l, n = -1,
				p = -1;
			l = a.one("#" + m);
			...
			if (a.isString(o) && o.indexOf("%") >= 0) {
				p = a.css(l, "height") * parseInt(o) / 100
			}
			if (p < 0 && o) {
				p = parseInt(o)
			}
		...
		bindUIViewEvents: function(m, k) {
			var n = m,
				l;
			k.onSelected = function(o) {
				var q = o.length,
					p;
				if (q > 0) {
					n.__SelectedImagesCount = q;
					p = o[q - 1];
					n.__cIndex = p;
					l = j.__SetSelectedImages(n, n.__cIndex, o);
			...
			k.onRefreshUI = function(o) {
				j.__innerRefreshFromUIView(n, o)
			};
			k.onResetCurrentIndex = function(o) {
				if (o >= 0 && n.__cIndex != o) {
					n._innerFun("CurrentImageIndexInBuffer", j.makeParams(o));
					n.__cIndex = o
				}
			};
			...
			k.onMouseDoubleClick = function(p) {
				var o = p.index;
				if (a.isFunction(n.__OnMouseDoubleClick)) {
					n.__OnMouseDoubleClick(o)
				}
			};
			k.onMouseRightClick = function(q) {
				var p = q.index;
				if (q) {
					var o = q.x,
						r = q.y;
				...
				if (a.isFunction(n.__OnMouseRightClick)) {
					return n.__OnMouseRightClick(p)
				}
				return d
			};
			k.onImageAreaSelected = function(o) {
				if (a.isFunction(n.__OnImageAreaSelected)) {
					n.__OnImageAreaSelected(o.index, o.left, o.top, o.right, o.bottom)
				}
			};
			k.onImageAreaDeSelected = function(o) {
				if (a.isFunction(n.__OnImageAreaDeSelected)) {
					n.__OnImageAreaDeSelected(o)
				}
			}
		},
		...
		getJson: function(r, l, s, k) {
			...
			var o = Dynamsoft.WebTwainEnv,
				n = [o.Trial ? "dwt_trial_" : "dwt_", a.replaceAll(o.ServerVersionInfo, ",", "")].join("");
			q.push(n);
			q.push('"');
			...
			z = function(F, C, E) {
				...
				if (D.state == 2 && D.status == 0) {
					if (D.statusText === "abort") {
						var m = d;
						a.Errors.HttpDownloadError(q, m)
					} else {
						a.Errors.HttpDownloadUrlError(q)
					}
				} else {
					a.Errors.HttpDownloadError(q, f, B, D.status)
				}
				if (a.isFunction(k)) {
					k()
				}
		...
		getServerSmallImageUrl: function(o, p, m) {
			var l = o.httpUrl,
				k = f,
				n = [l, "dwt/dwt_", h.Trial ? "trial_" : "", a.replaceAll(h.ServerVersionInfo, ",", ""), "/img?id=", o.clientId];
		...
		combineUrl: function(o, l, n) {
			...
			if (m.indexOf(":") < 0) {
				if (o.HTTPPort == "") {
					o.HTTPPort = a.detect.ssl ? 443 : 80
				}
				if ((!a.detect.ssl && o.HTTPPort != 80) || (a.detect.ssl && o.HTTPPort != 443)) {
					k.push(":");
					k.push(o.HTTPPort)
				}
			}
		...
		httpPostUploadString: function(o, k, q, n, u, l, p, r, w) {
			var v, m, s, t;
			if (q == "") {
				a.Errors.UploadFileCannotEmpty(o);
				if (a.isFunction(w)) {
					w()
				}
				return f
			...
			s = q.length;
			if (s > m && m != -1) {
				a.Errors.UploadExceededMaxSize(o);
				if (a.isFunction(w)) {
					w()
				}
				return f
			...
			v.name = n;
			t = this.httpUploadByBIO(o, k, v, u, d, l, p, r, w);
			v = null;
			return t
		},
		httpUploadByBIO: function(p, l, k, t, s, m, q, r, v) {
			...
			a.bio.on(a.BIO.event.SUCCESS, function(x) {
				a.bio = f;
				if (x && a.isString(x.response)) {
			...
			a.bio.on(a.BIO.event.ERROR, function(A) {
				var y = (A && A.canceled),
					B = (A && A.timeout),
					x = f,
					z = f;
				a.bio = f;
				if (A && a.isString(A.response)) {
				...
				a.Errors.UploadError(p, y, x, z);
				if (a.isFunction(v)) {
					v(p.__HTTPPostResponseString)
				}
			});
			if (q) {
				a.bio.on(a.BIO.event.PROGRESS, function(x) {
					delete(x.totalSize);
					delete(x.position);
		...
		setBtnCancelVisibleForProgress: function(m, l) {
			...
			if ((a.cancelFrome == 0 && m.__IfShowProgressBar == d) || (a.cancelFrome != 0 && m.__IfShowCancelDialogWhenImageTransfer == d)) {
				var o = a.one(".dynamsoft-btnCancel"),
					n = o && o[0];
				if (n) {
					if (l == f) {
		...
		handleEvent: function(n, l) {
			...
			if (o) {
				...
				a.each(j.SEND_BACK_EVENTS, function(r, q) {
				...
				a.each(a.Addon_Events, function(s, r) {
					if (l.event === s) {
						var q = ["_", s].join("");
						o = d;
						if (a.isFunction(n[q])) {
				...
				if (o) {
					...
					a.each(a.Addon_Sendback_Events, function(r, q) {
						if (j.isServerInvalid(n)) {
							return f
						}
						if (l.event === r) {
		...
		addImageFileExt: function(l, k) {
			...
			if (n == ".bmp" || n == ".jpg" || n == ".png" || n == ".tif" || n == ".tiff" || n == ".pdf") {
				return l
			}
		...
		isExpiredOrFuture: function(l, o) {
			if (l == "") {
				return f
			}
			if (!o) {
		...
		isBindDomainOK: function(q) {
			if (a.isUndefined(q) || q == null || q == "" || q == "*" || q == "*.*") {
				return d
			}
		...
		getEnumLicenseType: function(o) {
			var l = f,
				...
				k = f;
			if (a.isString(o)) {
				a.each(o.split(";"), function(v) {
					var u = v * 1;
					if (u == c.HTML5 || u == c.WinMacLinux) {
						l = d
					} else {
						if (u == c.Barcode1D) {
							s = d
		...
		getLicenseType: function(o) {
			...
			if (o && o != "") {
				o = o.toLowerCase();
				if (o == "html5" || o == "win=(aph) or mac=(ph) or linux(h)") {
					l = d
				} else {
					if (o == "1d barcode reader") {
						s = d
					} else {
						if (o == "2d barcode reader(qrcode)") {
							q = d
						} else {
							if (o == "2d barcode reader(pdf417)") {
								n = d
							} else {
								if (o == "2d barcode reader(data matrix)") {
									t = d
								} else {
									if (o == "ocr") {
										r = d
		...
		promptLicenseErr: function(l) {
			if (l.ErrorCode < 0) {
				var k = ['<div class="dynamsoft-dwt-dlg-tips">', l.ErrorString, "</div>", '<div style="padding-top:35px"></div>'];
				Dynamsoft.WebTwainEnv.ShowDialog(365, 0, k.join(""))
			}
		},
		checkPDFProductKeyWhenNeeds: function(o, p) {
			if (o.__addon && o.__addon.PDF) {
				var m = 1,
					l = 2,
					k = 4,
					n = o.__addon.PDF.GetConvertMode();
				if (p == k) {
					if (n == m || n == l) {
						return this.checkProductKey(o, {
							PDFRasterizer: d
						})
					}
				}
...
(function(a) {
	...
	b._OnReady = function(h) {
		...
		d.onmessage = function(m) {
			var k = m.data;
			if (typeof(k) === "object") {
				var u = g.curCommand_SaveImagesToBytes.shift() || {};
				if (u.sFun) {
					u.sFun(k)
				}
				u = null;
			...
			if (l.indexOf("Exception:") >= 0 || l.indexOf("Error") == 0) {
				...
				if (!p && a.isFunction(g.__OnPrintMsg)) {
					g.__OnPrintMsg(t)
				}
				return
			}
			...
			var u;
			if (l.cmdId) {
				var s = g.curCommand.length,
					o, j = -1;
				for (o = s - 1; o >= 0; o--) {
					if (g.curCommand[o].cmdId == l.cmdId) {
						j = o;
						u = g.curCommand.splice(j, 1)[0];
						break
					}
				}
				if (j < 0) {
					s = g.curCommand_SaveImagesToBytes.length;
					for (o = s - 1; o >= 0; o--) {
						if (g.curCommand_SaveImagesToBytes[o].cmdId == l.cmdId) {
							j = o;
							u = g.curCommand_SaveImagesToBytes.splice(j, 1)[0];
							break
						}
					}
					if (j < 0) {
			...
			if (l.result && l.result.length && l.result[0] == "1") {
				...
				if (l.exception) {
					var p = false;
					if (u.fFun) {
						p = u.fFun(g._errorString)
					}
					if (!p && l.exception && l.exception < 0 && l.exception != -2115) {
					...
					var q = ["result:"];
					if (u.fFun) {
						u.fFun(c.__pushElement(q, l.result))
					}
				}
			}
			l = null
...
(function(a) {
	...
	b._innerFunRaw = function(h, g, q, j, r, s, f) {
		var n = this,
			e, t, l;
		...
		l = {
			...
			data: t,
			async: k,
			onSuccess: function(u, p, m) {
				var v = false;
				try {
					if (a.isString(u) && m.getResponseHeader("content-type") === "text/json") {
						v = a.parse(u)
					} else {
						v = u
					}
				...
				if (v) {
					if (v.exception !== undefined && v.description !== undefined) {
						n._errorCode = v.exception;
						n._errorString = v.description
					} else {
						n._errorCode = 0;
						n._errorString = ""
					}
		...
		if (j) {
			if (Dynamsoft.Lib.env.bIE) {
				...
				l.onSuccess = function(A, C, v) {
					var p, x, B = false;
					if (v.responseHeadersString) {
						var u = v.responseHeadersString;
						if (u.indexOf("text/json") != -1) {
							B = true
						}
					}
					p = v.responseData;
					...
					if (p) {
						x = new Uint8Array(p);
						if (B) {
							p = String.fromCharCode.apply(null, x)
						} else {
							o = new Blob([x], {
	...
	b._innerSend = function(j, f, h, l, q) {
		var n = this,
			g = n._objWS,
			r = false,
			k = false,
		...
		if (j == "SaveSelectedImagesToBytes") {
			n.curCommand_SaveImagesToBytes.push({
				...
				fFun: r,
				objWS: g,
				json: d.getJson(n, j, f, s),
				binary: h
			});
			if (n.curCommand_SaveImagesToBytes.length == 1) {
				o = d.sendData(g, d.getJson(n, j, f, s), false, h)
			} else {
				o = true
			}
		} else {
	...
	b.__SaveSelectedImagesToBytes = function(k, j, g, l, o, f) {
		var m = this;
		if (l) {
			return m.__SaveSelectedImagesToBytesByBlock(k, j, g, o, f)
		} else {
			if (j <= 0 && g <= 0) {
				if (a.isFunction(f)) {
					f()
	...
	b.__GetSelectedImagesLength = function(g, k, j, m, e) {
		...
		var f = false,
			o = false;
		n = h._innerFunRaw("SaveSelectedImagesToBytes", d.makeParams(g, k, "", 0, 0), j, f, o, function(p) {
			if (h.ErrorCode == 0) {
				if (a.isFunction(m)) {
					if (a.isArray(p)) {
						l = m(p[0])
	...
	b.__LoadImageFromBytes = function(u, l, q, n, s, h, j, v) {
		var o = this,
			k = "LoadImageFromBytes",
			y = l || 3,
			r = u.size || u.length,
			g, e = d.isServerInvalid(o),
			x = true;
		if (!isNaN(j) && j >= 0 && !isNaN(v) && v > 0) {
			g = ["[", r, ",", 0, ",", y, ',"', q, '", ', j, ",", v, "]"].join("")
		} else {
			g = ["[", r, ",", 0, ",", y, ',"', q, '"]'].join("")
		}
		...
		if (!a.html5.Funs.checkProductKey(o, {
				Core: true
			})) {
			x = false;
			return w()
		}
		if (!a.html5.Funs.checkPDFProductKeyWhenNeeds(o, l)) {
			x = false;
			return w()
		}
		if (r === 0) {
			Dynamsoft.Lib.Errors.ImageFileLengthCannotZero(o);
			x = false;
			return w()
		}
		d.setBtnCancelVisibleForProgress(o, false);
		return this._innerSendBlob(k, g, u, n, function() {
			if (j + r == v || v <= 0 || isNaN(v)) {
				Dynamsoft.Lib.closeProgress(k)
			}
			o.__bLoadingImage = false;
			var f = o._UIManager.GetCurrentImageIndex();
			if (n && f >= 0) {
				o._UIManager.refreshEditor(f, o._UIManager.count());
				o.OnRefreshUI(f)
			}
			if (a.isFunction(s)) {
				s()
	...
	b._innerSendBlob = function(h, f, s, l, k, r) {
		var o = this,
			g = o._objWS,
			j = false,
			t = false;
		if (d.isServerInvalid(o)) {
			if (a.isFunction(r)) {
				r()
			}
			return false
		...
		if (l) {
			...
			d.sendData(g, d.getJson(o, h, f, u), s, true)
		} else {
			var q, e, v, n;
			if (d.isHttpServerInvalid(o)) {
				return false
			}
			o._errorCode = 0;
			o._errorString = "";
			e = [o.httpUrl, "f/", h, "?", d.getRandom()].join("");
			v = d.getJson(o, h, f, 0);
			v += "\r\n\r\n";
			v += Dynamsoft.Lib.base64.encodeArray(s);
			n = {
				method: "post",
				url: e,
				processData: false,
				data: v,
				async: false,
				onSuccess: function(w, p, m) {
					var x = false;
					try {
						if (a.isString(w) && m.getResponseHeader("content-type") === "text/json") {
							x = a.parse(w)
						} else {
							x = w
						}
					...
					if (x !== undefined && x !== null) {
						if (x.exception !== undefined && x.description !== undefined) {
							o._errorCode = x.exception;
							o._errorString = x.description
						} else {
							o._errorCode = 0;
							o._errorString = ""
						}
						...
						Dynamsoft.Lib.Errors.InvalidResultFormat(o);
						q = ""
					}
				},
				onError: function() {
					Dynamsoft.Lib.Errors.NetworkError(o);
					q = ""
				}
			};
			a.mix(n, {
...
(function(b) {
	...
	c.AcquireImage = function(o, n, m) {
		var j = this,
			l = null,
			f = null,
			p, k;
		if (b.isUndefined(m) && (b.isFunction(o) && b.isFunction(n) || b.isFunction(o) && b.isUndefined(n) || b.isFunction(o) && n == null || o == null && b.isFunction(n))) {
			k = {};
			if (b.isFunction(o)) {
				l = o
			}
		...
		k.EnableEvents = h;
		p = ["[", b.stringify(k), "]"].join("");
		return j.__innerAcquireImage("AcquireImage", p, false, l, f)
	};
...
(function(a) {
	...
	b.CreateTextFont = function(g, s, m, l, o, p, h, q, e, n, j, k, r, f) {
		return this._innerFun("CreateTextFont", d.makeParams(g, s, m, l, o, p, h, q, e, n, j, k, r, f))
	};
	...
	b.OverlayRectangle = function(j, l, k, g, f, e, h) {
		...
		if (l > g || k > f || (l == g && k == f)) {
			a.Errors.Overlay_InvalidLeftOrTopOrRightOrBottom(m);
			return false
		}
	...
	b.ChangeImageSize = function(o, f, l, n) {
		var h = this,
			j = parseInt(o),
			m = 1 * f,
			k = 1 * l,
...
(function(b) {
	...
	d.ShowFileDialog = function(l, j, q, p, o, h, k, r) {
		var n = this,
			m = g.replaceLocalFilename(o);
		return this._innerSend("ShowFileDialog", g.makeParams(l, j, q, p, m, h, k, r), true)
	};
	...
	d.FTPDownloadDirectly = function(p, n, h, m, j) {
		var o = this,
			k = g.replaceLocalFilename(h),
			l = b.html5.Funs.getImageType(k);
		return o.__innerFTPDownloadDirectly("FTPDownloadDirectly", g.makeParams(p, n, k), l, m, j)
	};
	...
	d.FTPUploadDirectly = function(o, h, m, l, j) {
		var n = this,
			k;
		...
		k = g.replaceLocalFilename(h);
		return n.__innerFTPUpload("FTPUploadDirectly", g.makeParams(o, k, m), l, j)
	};
	...
	d.HTTPDownloadDirectly = function(u, h, o, t, m) {
		var q = this,
			j = f.GetHttpHeadersAndClear(q),
			l = g.combineUrl(q, u, h),
			k, r, p;
		if (l === false) {
		...
		if (!o || o == "") {
			b.Errors.InvalidLocalFilename(q, "HTTPDownloadDirectly");
			if (b.isFunction(m)) {
				m(q.ErrorCode, q.ErrorString)
			}
			return false
		}
		k = b.html5.Funs.getImageType(o);
		...
		if (!b.html5.Funs.checkProductKey(q, {
				Core: true
			})) {
			if (b.isFunction(m)) {
				m(q._errorCode, q._errorString)
			}
			return false
		}
		if (!b.html5.Funs.checkPDFProductKeyWhenNeeds(q, k)) {
			if (b.isFunction(m)) {
				m(q._errorCode, q._errorString)
			}
			return false
		...
		b.cancelFrome = 2;
		p = g.replaceLocalFilename(o);
		r = "get";
		b.showProgress(q, "HTTPDownloadDirectly", true);
		var s = function(v) {
				var w = (v.total === 0) ? 100 : Math.round(v.loaded * 100 / v.total),
					x = [v.loaded, " / ", v.total].join("");
				q._OnPercentDone([0, w, "", "http"])
			},
			n = true;
		q._OnPercentDone([0, -1, "HTTP Downloading...", "http"]);
		if (!b.isFunction(t)) {
			n = false
		}
		ret = g.loadHttpBlob(q, r, l, n, function(v) {
			q._OnPercentDone([0, -1, "Loading..."]);
			var w = 3;
			return q.__LoadImageFromBytes(v, w, p, n, t, m)
		}, function() {
	...
	d.HTTPUploadThroughPostDirectly = function(v, q, h, o, u, n) {
		var s = this,
			j = f.GetHttpHeadersAndClear(s),
			k = "HTTPUploadThroughPostDirectly",
			l = g.combineUrl(s, v, h),
			p = true,
			r, t;
		if (v === "") {
			b.Errors.HttpServerCannotEmpty(s);
			if (b.isFunction(n)) {
				n(s.ErrorCode, s.ErrorString, "")
			}
			return false
		}
		if (l === false || l === "") {
		...
		if (!b.html5.Funs.checkProductKey(s, {
				Core: true
			})) {
			if (b.isFunction(n)) {
				n(s.ErrorCode, s.ErrorString, "")
		...
		b.showProgress(s, k, false);
		r = g.replaceLocalFilename(q);
		t = s.__SaveLocalFileToBytes(r, p, function(m) {
			b.needShowTwiceShowDialog = false;
			if (m && (b.dlgRef > 0 || s.__IfShowCancelDialogWhenImageTransfer == false || p == false)) {
				m.name = o;
				g.setBtnCancelVisibleForProgress(s, true);
				return g.httpPostUpload(s, l, m, p, 0, j, true, function(x) {
					b.closeProgress(k);
					if (b.isFunction(u)) {
						u(x)
					}
	...
	d.HTTPUploadThroughPost = function(l, k, h, o, n, j) {
		var m = g.getImageType(o);
		return this.HTTPUploadThroughPostEx(l, k, h, o, m, n, j)
	};
	d.HTTPUploadThroughPostEx = function(k, A, v, x, p, n, z) {
		var s = this,
			q = f.GetHttpHeadersAndClear(s),
			r = "HTTPUploadThroughPostEx",
			o = g.combineUrl(s, k, v),
			u = true,
			y = false,
			l = "",
			t = 0,
		...
		if (u) {
			switch (A) {
				case -1:
					...
					break;
				case -2:
					j = s._UIManager.GetSelectedIndexes();
					break;
				default:
					j.push(A);
					break
			...
			var h = function() {
				...
				b.closeProgress(r);
				if (b.isFunction(z)) {
					z(s.ErrorCode, s.ErrorString, s.__HTTPPostResponseString)
				}
				if (m > 0) {
					b.cancelFrome = 1;
					b.needShowTwiceShowDialog = true;
					b.showProgress(s, r, false);
			...
			if (A == -2) {
				y = g.__SetSelectedImages(s, s._UIManager.GetCurrentImageIndex(), s._UIManager.GetSelectedIndexes());
				if (!y) {
					return h()
				}
			} else {
			...
			y = s.__GetSelectedImagesLength(p, A, u, function(B) {
				var m = B.split(";");
				if (m.length == 2) {
					l = m[0];
					t = parseInt(m[1])
				...
				q["dwt-md5"] = l;
				y = s.__SaveSelectedImagesToBytes(p, 0, t, u, function(C) {
					b.needShowTwiceShowDialog = false;
					if (C && (b.dlgRef > 0 || s.__IfShowCancelDialogWhenImageTransfer == false || u == false)) {
						C.name = x;
						g.setBtnCancelVisibleForProgress(s, true);
						return g.httpPostUpload(s, o, C, u, 0, q, true, function(D) {
							var E = s.curCommand_SaveImagesToBytes.length;
							b.closeProgress(r);
							if (b.isFunction(n)) {
								n(D)
							}
							if (E > 0) {
								...
								b.needShowTwiceShowDialog = true;
								b.showProgress(s, r, false);
								var F = s.curCommand_SaveImagesToBytes[0];
	...
	d.HTTPUpload = function(j, q, o, p, l, h) {
		var n = this,
			k;
	...
	d._innerHTTPUpload = function(l, o, q, G, H, n, A) {
		...
		b.cancelFrome = 1;
		var h = function() {
			var m = y.curCommand_SaveImagesToBytes.length;
			b.needShowTwiceShowDialog = false;
			b.closeProgress(u);
			if (m > 0) {
				b.cancelFrome = 1;
				...
				var J = y.curCommand_SaveImagesToBytes[0];
				g.sendData(J.objWS, J.json, false, J.binary)
			}
			if (b.isFunction(A)) {
				A(y.ErrorCode, y.ErrorString, y.__HTTPPostResponseString)
			}
		...
		t = function(m) {
			var J = (m.total === 0) ? 100 : Math.round(m.loaded * 100 / m.total),
				K = [m.loaded, " / ", m.total].join("");
			y._OnPercentDone([0, J, "", "http"])
		};
		if (C == EnumDWT_UploadDataFormat.Binary) {
			...
			I = y.__GetSelectedImagesLength(r, v, B, function(J) {
				var m = J.split(";");
				if (m.length == 2) {
					k = m[0];
					w = parseInt(m[1])
				...
				if (F > 0 && w > F) {
					var L = 0,
						K = f.GetHttpHeadersAndClear(y);
					K["dwt-md5"] = k;
					y._OnPercentDone([0, -1, "HTTP Uploading...", "http"]);
			...
			if (C == EnumDWT_UploadDataFormat.Base64) {
				var H = g.addImageFileExt("RemoteFile", r);
				b.needShowTwiceShowDialog = true;
				b.showProgress(y, u, false);
				I = y.ConvertToBase64(o, r, function(L) {
					if (!L || L.getLength() <= 0) {
						b.Errors.UploadFileCannotEmpty(y);
						return h()
					}
					if (F > 0 && L.getLength() > F) {
						var M = 0,
							K = L.getMD5(),
							J = f.GetHttpHeadersAndClear(y);
						J["dwt-md5"] = K;
						y._OnPercentDone([0, -1, "HTTP Uploading...", "http"]);
						f.UploadBase64(y, p, r, L, H, J, M, x, t, function() {
							b.needShowTwiceShowDialog = false;
							b.closeProgress(u);
							if (b.isFunction(n)) {
								n(y.__HTTPPostResponseString)
						...
						y.__innnerHTTPUploadBase64Full(p, K, m, r, n, h)
					}
				}, h)
			}
		}
	...
	d._innerFormFieldHTTPUpload = function(j, p, h) {
		var r = this,
			l, n = "HTTPUpload",
			o = j,
			q = true,
		...
		l = function() {
			...
			b.closeProgress(n);
			if (b.isFunction(h)) {
				h(r.ErrorCode, r.ErrorString, r.__HTTPPostResponseString)
			}
			return false
		};
		if (b.isUndefined(o) || o === "") {
			b.Errors.ParameterCannotEmpty(r);
			return l()
		} else {
			if (!b.isString(o)) {
				b.Errors.InvalidUrl(r);
				return l()
			}
		}
		...
		r.__HTTPPostResponseString = "";
		b.cancelFrome = 1;
		b.showProgress(r, n, false);
		b.needShowTwiceShowDialog = true;
		var k = f.GetHttpHeadersAndClear(r);
		r._OnPercentDone([0, -1, "HTTP Uploading...", "http"]);
		s = g.httpUploadByBIO(r, o, c, 0, true, k, true, function(m) {
			b.needShowTwiceShowDialog = false;
			b.closeProgress(n);
			if (b.isFunction(p)) {
				p(m)
	...
	var f = {
		UploadBinary: function(r, n, t, q, k, h, o, s, u, p, w) {
			...
			if (v > 0) {
				...
				r.__SaveSelectedImagesToBytesByBlock(t, o, j, function(x, m) {
					if (!x) {
					...
					if (b.dlgRef > 0 || r.__IfShowCancelDialogWhenImageTransfer == false) {
						...
						g.httpPostUpload(r, n, x, true, 0, h, false, function(y) {
							...
							if (v == 0) {
								...
								setTimeout(function() {
									b.cancelFrome = 1;
									f.UploadBinary(r, n, t, k, h, o, s, u, p, w)
								}, 100)
							}
						}, w);
						return true
		...
		UploadBase64: function(r, n, t, y, o, h, p, s, u, q, w) {
			var k = y.getLength(),
				l = "HttpUpload",
				v, j, x = 0;
			v = k - p;
			if (v > 0) {
				...
				r.__GetBase64ResultDataAsync(-1, p, s, function(m) {
					strBase64Data = m[0];
					...
					if (b.dlgRef > 0 || r.__IfShowCancelDialogWhenImageTransfer == false) {
						g.setBtnCancelVisibleForProgress(r, true);
						h["Content-Range"] = ["bytes ", p, "-", p + j - 1, "/", k].join("");
						u({
							total: k,
							loaded: p
						});
						g.httpPostUploadString(r, n, strBase64Data, o, 0, h, false, function(z) {
							var A = r.curCommand_SaveImagesToBytes.length;
							if (A > 0) {
								b.cancelFrome = 1;
								var B = r.curCommand_SaveImagesToBytes[0];
								g.sendData(B.objWS, B.json, false, B.binary)
							}
							if (v == 0) {
								b.needShowTwiceShowDialog = false;
								...
								setTimeout(function() {
									b.cancelFrome = 1;
									f.UploadBase64(r, n, t, y, o, h, p, s, u, q, w)
								}, 100)
							}
						}, w);
						return true
	...
	d.__innnerHTTPUploadBinaryFull = function(k, j, v, p, z, l, h) {
		var u = this,
			r = f.GetHttpHeadersAndClear(u),
			s = "HTTPUpload",
			o = k,
			x = true,
			A = false,
			t = 0,
			w, y, q;
		z = g.addImageFileExt(z, p);
		var n = 0;
		r["dwt-md5"] = j;
		A = u.__SaveSelectedImagesToBytesByBlock(p, n, v, function(B, m) {
			if (!B || B.size <= 0) {
				b.Errors.UploadFileCannotEmpty(u);
				return h()
			}
			if (b.dlgRef > 0 || u.__IfShowCancelDialogWhenImageTransfer == false) {
				B.name = z;
				g.setBtnCancelVisibleForProgress(u, true);
				return g.httpPostUpload(u, o, B, x, t, r, true, function(C) {
					var D = u.curCommand_SaveImagesToBytes.length;
					b.needShowTwiceShowDialog = false;
					b.closeProgress(s);
					if (b.isFunction(l)) {
						l(C)
					...
					if (D > 0) {
						b.cancelFrome = 1;
						b.needShowTwiceShowDialog = true;
						b.showProgress(u, s, false);
						var E = u.curCommand_SaveImagesToBytes[0];
						g.sendData(E.objWS, E.json, false, E.binary)
					}
				}, h)
			} else {
				b.Errors.UploadError(u, true);
				return h()
			}
		}, h);
		return A
	};
	d.__innnerHTTPUploadBase64Full = function(j, v, z, x, q, y) {
		var s = this,
			k = f.GetHttpHeadersAndClear(s),
			l = "HTTPUpload",
			o, n = j,
			r = true,
			u = false,
			t = 0,
			p, w, h;
		o = g.addImageFileExt("RemoteFile", x);
		b.needShowTwiceShowDialog = true;
		...
		if (b.dlgRef > 0 || s.__IfShowCancelDialogWhenImageTransfer == false) {
			...
			g.setBtnCancelVisibleForProgress(s, true);
			return g.httpPostUploadString(s, n, z, o, 0, k, true, function(m) {
	...
	d.ConvertToBase64 = function(r, p, l, h) {
		var n = this,
			j = parseInt(p),
		...
		o = g.__SetSelectedImages(n, n._UIManager.GetCurrentImageIndex(), r);
		if (!o) {
			if (b.isFunction(h)) {
				h(n.ErrorCode, n.ErrorString)
			}
		...
		o = n._innerSend(k, g.makeParams(j, 0, 0), true, function(v) {
			var s, m = 0,
				u = "",
				t;
			if (n.ErrorCode != 0) {
			...
			if (v && b.isArray(v) && v.length == 1) {
				t = v[0].split(";");
				if (t.length == 2) {
					u = t[0];
					m = parseInt(t[1])
				}
				s = new b.html5.Base64Result(n, m, u);
				b.closeProgress(k);
				if (b.isFunction(l)) {
					l(s)
				}
	...
	d.HTTPUploadAllThroughPostAsMultiPageTIFF = function(l, h, o, n, k) {
		var j = -1,
			m = 2;
		return this.HTTPUploadThroughPostEx(l, j, h, o, m, n, k)
	};
	d.HTTPUploadThroughPostAsMultiPageTIFF = function(l, h, p, n, k) {
		var o = this,
			j = -2,
			m = 2;
		return o.HTTPUploadThroughPostEx(l, j, h, p, m, n, k)
	};
	d.HTTPUploadAllThroughPostAsPDF = function(l, h, p, n, k) {
		var o = this,
			j = -1,
			m = 4;
		return this.HTTPUploadThroughPostEx(l, j, h, p, m, n, k)
	};
	d.HTTPUploadThroughPostAsMultiPagePDF = function(l, h, p, n, k) {
		var o = this,
			j = -2,
			m = 4;
		return o.HTTPUploadThroughPostEx(l, j, h, p, m, n, k)
	};
	d.HTTPDownloadThroughPost = function(t, h, k, s, m) {
		var o = this,
			j = f.GetHttpHeadersAndClear(o),
			l = g.combineUrl(o, t, h),
			q, p;
		if (l === c) {
			b.Errors.ParameterCannotEmpty(o);
			return c
		}
		if (g.isServerInvalid(o)) {
			if (b.isFunction(m)) {
				m(o.ErrorCode, o.ErrorString)
			}
			return c
		}
		if (!b.html5.Funs.checkProductKey(o, {
				Core: a
			})) {
			if (b.isFunction(m)) {
				m(o._errorCode, o._errorString)
			}
			return c
		}
		if (!b.html5.Funs.checkPDFProductKeyWhenNeeds(o, k)) {
			if (b.isFunction(m)) {
				m(o._errorCode, o._errorString)
			}
			return c
		...
		b.cancelFrome = 2;
		b.showProgress(o, "HttpDownloadThroughPost", a);
		q = "post";
		var r = function(u) {
		...
		p = g.loadHttpBlob(o, q, l, n, function(u) {
			...
			o.__LoadImageFromBytes(u, v, w, n, s, m)
		}, function() {
	...
	d.HTTPDownloadThroughGet = function(t, h, k, s, m) {
		var o = this,
			j = f.GetHttpHeadersAndClear(o),
			l = g.combineUrl(o, t, h),
			q, p;
		...
		b.cancelFrome = 2;
		q = "get";
		b.showProgress(o, "HTTPDownloadThroughGet", a);
		var r = function(u) {
				var v = (u.total === 0) ? 100 : Math.round(u.loaded * 100 / u.total),
					w = [u.loaded, " / ", u.total].join("");
				o._OnPercentDone([0, v, "", "http"])
	...
	d.HTTPUploadThroughPutEx = function(u, w, s, q, t, l) {
		var o = this,
			h = f.GetHttpHeadersAndClear(o),
			j = "HTTPUploadThroughPutEx",
			k = g.combineUrl(o, u, s),
			n = true,
			p = false;
		if (k === false) {
			b.Errors.ParameterCannotEmpty(o);
		...
		var v = function() {
				...
				b.closeProgress(j);
				if (b.isFunction(l)) {
					l(o.ErrorCode, o.ErrorString, o.__HTTPPostResponseString)
				}
				if (m > 0) {
					b.cancelFrome = 1;
					b.needShowTwiceShowDialog = true;
					b.showProgress(o, j, false);
					var x = o.curCommand_SaveImagesToBytes[0];
					g.sendData(x.objWS, x.json, false, x.binary)
				}
				return false
			},
			r;
		...
		b.showProgress(o, j, false);
		if (u === "") {
			b.Errors.HttpServerCannotEmpty(o);
			return v()
		}
		if (w == -2) {
			p = g.__SetSelectedImages(o, o._UIManager.GetCurrentImageIndex(), o._UIManager.GetSelectedIndexes());
			if (!p) {
				return v()
			}
		} else {
		...
		p = o.__GetSelectedImagesLength(q, w, n, function(x) {
			var m = x.split(";");
			if (m.length == 2) {
				md5 = m[0];
				iLen = parseInt(m[1])
			...
			h["dwt-md5"] = md5;
			p = o.__SaveSelectedImagesToBytes(q, 0, iLen, n, function(y) {
				b.needShowTwiceShowDialog = false;
				if (y && (b.dlgRef > 0 || o.__IfShowCancelDialogWhenImageTransfer == false || n == false)) {
					r = function(z) {
						var A = (z.total === 0) ? 100 : Math.round(z.loaded * 100 / z.total),
							B = [z.loaded, " / ", z.total].join("");
						o._OnPercentDone([0, A, "", "http"])
					};
					o._OnPercentDone([0, -1, "uploading...", "http"]);
					g.setBtnCancelVisibleForProgress(o, true);
					return g.httpPutImage(o, k, y, n, function(z) {
						var A = o.curCommand_SaveImagesToBytes.length;
						o.__HTTPPostResponseString = z;
						b.closeProgress(j);
						if (b.isFunction(t)) {
							t(o.__HTTPPostResponseString)
						}
						if (A > 0) {
							b.cancelFrome = 1;
							b.needShowTwiceShowDialog = true;
							b.showProgress(o, j, false);
							var B = o.curCommand_SaveImagesToBytes[0];
							g.sendData(B.objWS, B.json, false, B.binary)
						}
						return true
					}, v, r)
	...
	d.HTTPUploadThroughPutAsMultiPageTIFF = function(l, h, n, k) {
		var o = this,
			j = -2,
			m = 2;
		return o.HTTPUploadThroughPutEx(l, j, h, m, n, k)
	};
	...
	d.ConvertToBlob = function(u, s, n, h) {
		var p = this,
			k = parseInt(s),
			l = "ConvertToBlob",
			o = true,
		...
		if (g.isServerInvalid(p)) {
			if (b.isFunction(h)) {
				h(p.ErrorCode, p.ErrorString)
			}
			return false
		}
		if (!p._checkIndices(u)) {
			if (b.isFunction(h)) {
				h(p.ErrorCode, p.ErrorString)
			}
			return false
		...
		if (k == EnumDWT_ImageType.IT_BMP || k == EnumDWT_ImageType.IT_JPG || k == EnumDWT_ImageType.IT_PNG) {
			if (u.length > 1) {
				b.Errors.ConvertBinaryIndexMoreThanOne(p);
				if (b.isFunction(h)) {
					h(p.ErrorCode, p.ErrorString)
				}
				return false
		...
		var t = function() {
			...
			if (m > 0) {
				...
				b.needShowTwiceShowDialog = true;
				b.showProgress(p, l, false);
				var v = p.curCommand_SaveImagesToBytes[0];
				g.sendData(v.objWS, v.json, false, v.binary)
			}
			return false
		};
		r = g.__SetSelectedImages(p, p._UIManager.GetCurrentImageIndex(), u);
		if (!r) {
			t();
			return false
		}
		r = p.__GetSelectedImagesLength(k, -2, o, function(v) {
			var m = v.split(";");
			if (m.length == 2) {
				q = m[0];
				j = parseInt(m[1])
			}
			r = p.__SaveSelectedImagesToBytes(k, 0, j, o, function(y) {
				b.needShowTwiceShowDialog = false;
				b.closeProgress(l);
				if (b.isFunction(n)) {
					if (y instanceof Blob) {
						var x = g.getBlobTypeByImageType(k);
						n(y.slice(0, j, x))
					} else {
						n(y)
					}
				}
				var w = p.curCommand_SaveImagesToBytes.length;
				if (w > 0) {
					b.cancelFrome = 0;
					b.needShowTwiceShowDialog = true;
					b.showProgress(p, l, false);
					var z = p.curCommand_SaveImagesToBytes[0];
	...
	b._asyUploadLoop = function() {
		...
		var l = b._aryUploadCmd[0];
		b._aryUploadCmd.splice(0, 1);
		var o = l._this,
			m = l.bOnlyUploadForm,
			k = l.url,
			n = l.asyncSuccessFunc,
			j = l.asyncFailureFunc;
		if (m) {
			o._innerFormFieldHTTPUpload(k, function() {
				if (b.isFunction(n)) {
					try {
				...
				if (b.isFunction(j)) {
					try {
						j(o.ErrorCode, o.ErrorString, o.__HTTPPostResponseString)
					} catch (s) {}
				}
				setTimeout(b._asyUploadLoop, 0)
			})
			...
			var r = l.indices,
				...
				q = l.dataFormat,
				h = l.filename;
			o._innerHTTPUpload(k, r, p, q, h, function() {
				if (b.isFunction(n)) {
					try {
						n(o.__HTTPPostResponseString)
					} catch (s) {}
...
(function(a) {
	...
	b._OnBitmapChanged = function(p) {
		...
		o.__cIndex = g;
		o._HowManyImagesInBuffer = k;
		Dynamsoft.Lib.log(h + p);
		if (e == n || e == j) {
			Dynamsoft.Lib.each(l, function(t) {
				var u = parseInt(t),
					m = "item_" + u;
				if (isNaN(u) || u < 0) {
					return true
				}
				o._UIManager.add(u, k, f)
			});
			if (Dynamsoft.Lib.isFunction(o.__OnRefreshUI)) {
				o.__OnRefreshUI(g, k)
			}
		} else {
			if (e == q) {
				if (l.length == 1 && l[0] == -1 || k == 0) {
					...
					Dynamsoft.Lib.each(l, function(t, m) {
						var u = parseInt(t);
						if (isNaN(u) || u < 0) {
							return true
						}
						o._UIManager.remove(u, g)
					});
					if (g >= 0 && !o.__bLoadingImage && o._UIManager.count() > 0) {
						o._UIManager.refreshEditor(g, k)
					}
				}
				if (Dynamsoft.Lib.isFunction(o.__OnRefreshUI)) {
					o.__OnRefreshUI(g, k)
				...
				if (e == r) {
					Dynamsoft.Lib.each(l, function(t, m) {
						...
						if (u >= 0 && !o.__bLoadingImage) {
							o.OnRefreshUI(u, k, true, f)
						}
					})
				} else {
					if (e == s) {
						if (g >= 0 && !o.__bLoadingImage) {
							o.OnRefreshUI(g, k, true, f)
						}
					}
				}
			}
		}
		if (Dynamsoft.Lib.isFunction(o.__OnBitmapChanged)) {
			o.__OnBitmapChanged(l, e, g, k)
		}
	};
	b._OnPostLoad = function(m, e) {
		...
		g = m[1].split(",");
		o = Dynamsoft.Lib.base64.decode(g[0]);
	...
	b._OnPercentDone = function(o) {
		...
		if ((Dynamsoft.Lib.cancelFrome == 0 && j.__IfShowProgressBar == true) || (Dynamsoft.Lib.cancelFrome != 0 && j.__IfShowCancelDialogWhenImageTransfer == true)) {
			...
			if (k < 0) {
				k = 0;
				Dynamsoft.Lib.progressMessage = o[2];
				l = Dynamsoft.Lib.progressMessage
			} else {
				if (o[2] != "") {
					l = Dynamsoft.Lib.progressMessage + "(" + o[2] + ")"
				} else {
					l = Dynamsoft.Lib.progressMessage
				}
...
(function(b) {
	...
	e.LoadImageFromBase64Binary = function(l, q, r, k) {
		var o = this,
			j = c,
		...
		if (!b.html5.Funs.checkPDFProductKeyWhenNeeds(o, n)) {
			return c
		}
		if (b.isFunction(r)) {
			j = a
		...
		if (j) {
			if (g.isServerInvalid(o)) {
				if (b.isFunction(k)) {
					k(o.ErrorCode, o.ErrorString)
				}
				return c
			}
			b.cancelFrome = 2;
			b.showProgress(o, h, a);
			o.__bLoadingImage = a;
			p = o._innerSend(h, g.makeParams(l, n), j, function() {
				Dynamsoft.Lib.closeProgress(h);
				o.__bLoadingImage = false;
				var m = o._UIManager.GetCurrentImageIndex();
				if (m >= 0) {
					o._UIManager.refreshEditor(m, o._UIManager.count());
					o.OnRefreshUI(m)
				}
				r && r();
				return true
			...
			p = o._innerFun(h, g.makeParams(l, n));
			if (o.ErrorCode == 0) {
				o._HowManyImagesInBuffer = o._innerFun("HowManyImagesInBuffer");
				o.__cIndex = o._innerFun("CurrentImageIndexInBuffer")
			}
		}
		return p
	};
	...
	e.GetImageURL = function(o, j, h, s) {
		var n = this,
			p = o,
			q = parseInt(j),
			m = parseInt(h),
		...
		l = [r, k, "dwt_", d.Trial ? "trial_" : "", b.replaceAll(d.ServerVersionInfo, ",", ""), "/img?id=", n.clientId];
		...
		if (p < 0 || p >= n.HowManyImagesInBuffer) {
...
(function(b) {
	...
	c.prototype.onMouseDown = function(s) {
		var m = this,
			o = s.target,
			j = d,
			h, q, k, r, l, n, p;
		if (o == m.canvas || o == m.divArrow1 || o == m.divArrow2) {
			if (o == m.canvas) {
				h = b.DOM.getOffset(s);
			...
			if (n <= m.arrowSize) {
				p = m._currentPosition;
				m.__click_previous();
				if (p != m._currentPosition) {
		...
		if (j) {
			...
			onMouseMove = function(w) {
				...
				x.x = m.mousePos_StartDrag.x + v.clientX - disX;
				x.y = m.mousePos_StartDrag.y + v.clientY - disY;
				e.output("onMouseMove: " + x.x + " " + x.y);
				if (m.dragging) {
					var u = m.__caculateDraggingNewPosition(x.x, x.y);
					if (u != m._currentPosition) {
						m.SetPosition(u);
						m.__fireEvent("onValueChanged", {
							Value: m._currentPosition,
	...
	c.prototype.__drawRightTriangle = function(v, j, r) {
		var o = this,
			s, q, m, g, f, t = 4,
			n = 7,
			z, u, k, l;
		...
		v.putImageData(f, j, r)
	};
	c.prototype.__drawBox = function(u, j, q, f, t, r, p, h, m, s) {
		var n = this,
			g = 0,
			k, l;
		if (f <= 0 || t <= 0) {
		...
		if (u) {
			u.fillStyle = r;
			u.fillRect(j, q, k, l);
			u.lineWidth = n.borderWidth;
			b.drawBoxBorder(u, j + g, q + g, k - g, l - g, p, h);
			j += n.borderWidth;
			q += n.borderWidth;
			k -= 2 * n.borderWidth;
			l -= 2 * n.borderWidth;
			b.drawBoxBorder(u, j + g, q + g, k - g, l - g, m, s)
		} else {
			if (n.divSlide) {
				n.divSlide.style.backgroundColor = r;
				n.divSlide.style.left = j + "px";
				n.divSlide.style.top = q + "px";
...
(function(b) {
	...
	e.prototype.__draw_dashRect = function(g, m, f, n) {
		...
		p = k.canvas.getContext("2d");
		k.__restoreCanvas(p, p.canvas.width, p.canvas.height);
		if (h > 0 && j > 0) {
			p.__dashedLineRect(q + k.Left, o + k.Top, h, j)
		}
	};
	e.prototype.SetSelectedArea = function(h, q, r, g, k) {
		var o = this,
			t = o.canvas.getContext("2d"),
			v, s, f, n, j, l, p = o.drawWidth,
			u = o.drawHeight,
			m = false;
		d.output("SetSelectedArea: " + [h, q, r, g].join(","));
		if (!o.canvas) {
			return false
		}
		if (h < r) {
		...
		if (m) {
			v = o.selectedCanvasArea.left;
			s = o.selectedCanvasArea.top;
			f = o.selectedCanvasArea.right;
			n = o.selectedCanvasArea.bottom;
			if (v == 0 && s == 0 && f == 0 && n == 0) {} else {
				o.selectedCanvasArea.left = 0;
				o.selectedCanvasArea.top = 0;
				o.selectedCanvasArea.right = 0;
				o.selectedCanvasArea.bottom = 0;
				o.__restoreCanvas(t, t.canvas.width, t.canvas.height);
				if (k) {
					o.__fireEvent("onImageAreaDeSelected")
				}
			}
		} else {
			o.selectedCanvasArea.left = v;
			o.selectedCanvasArea.top = s;
			o.selectedCanvasArea.right = f;
			o.selectedCanvasArea.bottom = n;
			o.__draw_dashRect(v, s, j, l);
			if (k && (o.__mousedownStatus == 0)) {
				o.__fireEvent("onImageAreaSelected", {
					left: v,
					top: s,
					right: f,
					bottom: n,
	...
	e.prototype.Destroy = function() {
		...
		d.output("Destroy:");
		if (k.canvas) {
			var f = k.canvas.getContext("2d");
			if (k.__controlWidth > 0 && k.__controlHeight > 0) {
				f.clearRect(0, 0, k.__controlWidth, k.__controlHeight)
			}
	...
	e.prototype.__funReSelectArea = function(o) {
		var l = this,
			q, p, f, k, n, g = true;
		q = l.mouse_zero_x;
		p = l.mouse_zero_y;
		...
		l.SetSelectedArea(q, p, f, k, true)
	};
...
(function(a) {
	...
	CanvasRenderingContext2D.prototype.__dashedLineRect = function(n, j, c, o, f) {
		...
		for (var d = 0; d < 4; d++) {
			var s = (m[d] - l[d]);
			var q = (h[d] - k[d]);
			var b = Math.floor(Math.sqrt(s * s + q * q));
			var g = (f <= 0) ? b : (b / f);
			var p = (q / b) * f;
			var r = (s / b) * f;
			this.beginPath();
			for (var e = 0; e < g; e++) {
				if (e % 2) {
					this.lineTo(l[d] + e * r, k[d] + e * p)
				} else {
					this.moveTo(l[d] + e * r, k[d] + e * p)
				}
			}
			this.stroke()
		}
...
(function(c) {
	...
	var b = true,
		...
		e = {
			...
			getAdjustedImageSize: function(o, j, p, k) {
				var m = {
						w: o,
						h: j,
						zoom: 1
					...
					f = Math.floor(p + 0.5),
					n = Math.floor(k + 0.5);
				e.output(["image info:", o, ",", j, "; max is ", f, ",", n].join(""));
				if (f <= o || n <= j) {
					if (f <= o && n <= j) {
						var g = f / o,
							l = n / j;
						if (g < l) {
							m.w = Math.floor(o * g + 0.5);
							m.h = Math.floor(j * g + 0.5);
							m.zoom = g
						} else {
							m.w = Math.floor(o * l + 0.5);
	...
	a.prototype.SetSelectedImageArea = function(l, h, q, g) {
		var n = this,
			t = l,
			s = h,
			f = 0,
			m = 0,
			j = 1;
		e.output("SetSelectedImageArea:" + [l, h, q, g].join(", "));
		if (q < l && g < h) {
			t = parseInt(q);
			s = parseInt(g);
			f = parseInt(l);
		...
		n.selectedImageArea.left = t;
		n.selectedImageArea.top = s;
		...
		if (n.imageAreaSelector) {
			...
			var k = t * j,
				...
				r = f * j,
				p = m * j;
			n.imageAreaSelector.SetSelectedArea(k, o, r, p);
			return true
		}
		return false
	};
	a.prototype.OverlayRectangle = function(m, l, o, h, f, k) {
		var n = this;
		e.output("OverlayRectangle:" + [m, l, o, h, f, k].join(", "));
		n.bHasOverlay = b;
		if (n._origImageWidth <= 0) {
			n.__getImageOrignalSize()
		}
		n.__refreshImageOverlayInfo();
		n.__overlay.Add(m, l, o, h, f, k, true);
		n.drawArea.x = 0;
		n.drawArea.y = 0;
		if (n.drawArea.width <= n.canvasWidth) {
			n.drawArea.x = (n.drawArea.width - n.canvasWidth) * 0.5
		} else {
			var j = Math.floor((m * n.fZoomValue + o * n.fZoomValue - n.canvasWidth) / 2 - n.drawArea.x);
			n.drawArea.x = j > 0 ? j : 0
		}
		if (n.drawArea.height <= n.canvasHeight) {
			n.drawArea.y = (n.drawArea.height - n.canvasHeight) * 0.5
		} else {
			var g = Math.floor((l * n.fZoomValue + h * n.fZoomValue - n.canvasHeight) / 2 - n.drawArea.y);
			n.drawArea.y = g > 0 ? g : 0
		}
		n.__setDrawArea(n.drawArea.x, n.drawArea.y, n.drawArea.width, n.drawArea.height);
		n.__resetScroll();
		n.Show();
		return true
	};
	...
	a.prototype.SetZoom = function(s, m, l, h, g) {
		var n = this,
			j, k = {},
			q, f, r;
		e.output("SetZoom:" + [j, s].join("->"));
		n.fUserSetZoom = s;
		k.x = n.drawArea.x;
		k.y = n.drawArea.y;
		...
		if (!c.isUndefined(m) && !c.isUndefined(l)) {
			k.bMoveCenter = true;
			var p = (m / n.fZoomValue);
			var o = (l / n.fZoomValue);
			k.newRealCenterX = m;
			k.newRealCenterY = l;
			k.newClickX = h;
			k.newClickY = g
		...
		n.__recaculateDrawArea();
		q = n.__getScrollInfoWithNewZoom(k);
		n.__setDrawArea(q.x, q.y, n.drawArea.width, n.drawArea.height);
		n.__resetScroll();
		n.Show();
		return true
	};
	...
	a.prototype.Destroy = function() {
		...
		g.SetBindIndex(-1);
		if (g.canvas) {
			var f = g.canvas.getContext("2d");
			if (g.canvasWidth > 0 && g.canvasHeight > 0) {
				f.clearRect(0, 0, g.canvasWidth, g.canvasHeight)
			}
		}
		g.ClearImage();
		if (g.imageAreaSelector) {
			g.imageAreaSelector.Destroy();
			g.imageAreaSelector = false
		}
		if (g.__overlay) {
			g.__overlay.Destroy()
	...
	a.prototype.__getScrollInfoWithNewZoom = function(D) {
		var z = this,
			F = {
				x: 0,
				y: 0
		...
		if (!D.bMoveCenter) {
			if (o) {
				h = u = z.objImage.width * 0.5;
				g = t = z.objImage.height * 0.5;
				n = u * q;
				l = t * q
			} else {
				h = h + x * 0.5;
			...
			n = D.newRealCenterX * q;
			l = D.newRealCenterY * q
		}
		bOldShowScrollV = z.__isShowScrollV(x), bOldShowScrollH = z.__isShowScrollH(j);
		y = z.__isShowScrollV(), G = z.__isShowScrollH();
		f = z.canvasWidth;
		r = z.canvasHeight;
		if (D.bMoveCenter) {
			var B = (z.drawArea.width - f) * 0.5,
				m = D.x,
				k = D.newRealCenterX * q,
				v = D.newRealCenterX * w,
				E = B - k - m + v;
			F.x = B - E;
			var s = (z.drawArea.height - r) * 0.5,
				A = D.y,
				k = D.newRealCenterY * q,
				v = D.newRealCenterY * w,
				E = s - k - A + v;
			F.y = s - E;
			return F
		}
	...
	a.prototype.__resetScroll = function() {
		var h = this,
			...
			p, j, o, m, n;
		if (h.canvas) {
			o = h.canvas.parentNode
		}
		if (!o) {
			return
		}
		h.__overlay.left = -h.drawArea.x;
		h.__overlay.top = -h.drawArea.y;
		if (f) {
			...
			if (!h.scrollV) {
				...
				k.onValueChanged = function(q) {
					h.drawArea.y = q.Value;
...
(function(a) {
	...
	Funs2 = {
		...
		print: function(u) {
			...
			var B = window.open("about:blank", "_blank", x);
			if (B) {
				B.document.write(k);
				B.document.close();
				B.focus();
	...
	function d(m, l, s, t, o, k, u, r, n, q) {
		var p = this;
		p.iControlIndex = m;
		p.iImageIndex = l;
		p.View = s;
	...
	f.prototype.__UpdateImageByScrollBar = function(n) {
		...
		Funs2.output(q, "__UpdateImageByScrollBar(value, newIndex): " + [n, m].join(","));
		q.__GoInner(m, false, true)
	};
	f.prototype.UpdateImage = function(m, o, l, k, s, q) {
		var p = this;
		...
		if (null != r) {
			...
			if (o != null && (o.src == "data:," || o.width == 0 || o.height == 0 || o.src == "")) {
				var n = p.__GetImageControlIndex(m);
				if (n >= 0) {
				...
				if (o == null) {
					var n = p.__GetImageControlIndex(m);
					if (n >= 0) {
						var l = parseInt(p.imageViewWidth / 2);
						var k = parseInt(p.imageViewHeight / 2);
	...
	f.prototype.UpdateAllImage = function(o, k, m, l) {
		var n = this;
		return n.UpdateAllImageInner(o, k, false, m, l)
	};
	f.prototype.UpdateAllImageInner = function(r, k, o, n, m) {
		var q = this;
	...
	f.prototype.__OnMouseClick = function(l) {
		var o = this;
		var p = l.index;
		var s = o.aryCurrentSelectedImageIndicesInBuffer.indexOf(p),
			k = l.e.ctrlKey,
			q = l.e.shiftKey,
			r = l.e.metaKey;
		if (s == -1) {
			if (k || q || r || o.aryCurrentSelectedImageIndicesInBuffer.length < 1) {
				...
				if (o.aryCurrentSelectedImageIndicesInBuffer.length == 1) {
					...
					o.aryCurrentSelectedImageIndicesInBuffer = [];
					o.aryCurrentSelectedImageIndicesInBuffer.push(p)
				}
			}
		} else {
		...
		if (q) {
			var v = o.aryCurrentSelectedImageIndicesInBuffer[0],
				n = o.aryCurrentSelectedImageIndicesInBuffer[o.aryCurrentSelectedImageIndicesInBuffer.length - 1];
			o.aryCurrentSelectedImageIndicesInBuffer = [];
			if (n == v) {
				o.aryCurrentSelectedImageIndicesInBuffer.push(parseInt(v))
			} else {
				if (n > v) {
					var t = n - v + 1;
					for (var m = 0; m < t; m++) {
						o.aryCurrentSelectedImageIndicesInBuffer.push(parseInt(v + m))
					}
				} else {
					var t = v - n + 1;
					o.aryCurrentSelectedImageIndicesInBuffer.push(parseInt(v));
		...
		if (o.aryCurrentSelectedImageIndicesInBuffer.length == 1) {
			o.__OnlySetCurrentIndex(o.aryCurrentSelectedImageIndicesInBuffer[0]);
			o.__SetCurrentIndexWithoutSetScroll(o.cCurrentIndex)
		}
		o.__SortCurrentSelectedImageIndicesInBuffer();
		o.__SetUnselectAll();
		var m = 0;
		for (m = 0; m < o.aryCurrentSelectedImageIndicesInBuffer.length; m++) {
			var u = o.GetImageControl(o.aryCurrentSelectedImageIndicesInBuffer[m]);
			if (null != u) {
				u.SetSelect(true)
			}
		}
	...
	f.prototype.__SetCurrentIndexInnerInner = function(s, u, x, r) {
		var q = this,
			m = true;
		...
		if (m) {
			if (q.bVerticalMode == true) {
				...
				if (q.iCurrentRow != v && (q.iCurrentRow <= q.iOldFirstVisibleRow || ((q.iCurrentRow - q.iOldFirstVisibleRow) >= q.imagesPerRow))) {
		...
		if (u) {
			...
			var w = q.GetImageControl(q.cCurrentIndex);
			if (null != w) {
				w.SetSelect(true)
			}
		}
	};
	f.prototype.__SetScrollByIndex = function(q) {
		var p = this;
	...
	f.prototype.__AttachImagesInner = function(q, r, k, m) {
		var p = this;
		if (p.aryImageControls && p.aryImageControls.length > 0) {
			...
			for (n = 0; n < p.aryImageControls.length; n++) {
				...
				if (t) {
					var o = s + n;
					Funs2.output(p, "__AttachImagesInner(baseIndex, index): " + [s, o].join(","));
					if (o < p.sHowManyImages) {
						...
						if (r) {
							...
							if (o >= l && o <= v || u.bIsDirty == true || t.GetCurrentIndex() != o) {
								Funs2.output(p, "__AttachImagesInner() attach Image index -> control index:" + [o, n].join("->"));
								p.__GetImageAndAttach(t, u, o, false)
							}
						}
						t.SetVisible(true);
						Funs2.output(p, "__AttachImagesInner() set control index Visible:" + [n].join());
						if (p.__IfContains(p.aryCurrentSelectedImageIndicesInBuffer, o)) {
							Funs2.output(p, "__AttachImagesInner() set control index selected:" + [n].join());
							t.SetSelect(true)
						} else {
							t.SetSelect(false)
						}
					} else {
						Funs2.output(p, "__AttachImagesInner() set control index InVisible:" + [n].join());
						t.SetVisible(false)
					}
				}
			}
				...
				if (o.bVerticalMode == true) {
					if ((m + 1) % o.imagesPerColumn == 0) {
						...
						if (o.bScrollBar == false) {
							if ((n + iControlHeight) > o.imageViewHeight) {
								n = o.ImageMargin
							}
						}
					}
		...
		if (q.bSingleMode == false) {
			...
			if (q.bVerticalMode == true) {
				...
				if (q.ImageMargin <= 0 || (q.ImageMargin > (q.imageViewWidth - l - 3 * q.imagesPerColumn)) || (q.ImageMargin > (q.imageViewHeight - 3 * q.imagesPerRow))) {
					var o = parseInt(q.imageViewHeight / (q.imagesPerRow * 10));
					var p = parseInt((q.imageViewWidth - l) / (q.imagesPerColumn * 10));
					var n = o < p ? o : p;
					if (q.ImageMargin <= 0) {
				...
				if (q.ImageMargin <= 0 || (q.ImageMargin > (q.imageViewWidth - 3 * q.imagesPerColumn)) || (q.ImageMargin > (q.imageViewHeight - l - 3 * q.imagesPerRow))) {
					var o = parseInt(q.imageViewHeight - l) / (q.imagesPerRow * 10);
					var p = parseInt((q.imageViewWidth) / (q.imagesPerColumn * 10));
					var n = o < p ? o : p;
					if (q.ImageMargin <= 0) {
						q.ImageMargin = parseInt(n)
					} else {
	...
	f.prototype.SetSelectedImageArea = function(m, p, o, n, l) {
		var q = this;
	...
	f.prototype.OverlayRectangle = function(t, p, o, s, m, l, n) {
		var q = this;
	...
	f.prototype.SetViewMode = function(s, l) {
		var o = this;
		var m = o.imagesPerColumn;
		var p = o.imagesPerRow;
		var t = o.bSingleMode;
		var k = o.bVerticalMode;
		if (s > 0) {
			o.imagesPerColumn = s
		}
		if (l > 0) {
		...
		o.__SetUnselectAll();
		o.__SetSelectedImageIndicesInBuffer();
		return true
	};
	...
	f.prototype.__GetImageAndAttach = function(s, p, m, o) {
		var q = this;
		...
		if (o) {
			...
			if (p.bIsDirty == true || p.iImageControlWidth < l || p.iImageControlHeight < k || (p.iImageControlWidth > 0 && l == -1) || (p.iImageControlHeight > 0 && k == -1)) {
				r = true
			} else {
				r = false
			}
		...
		if (n >= 0) {
			q.__SetArrayControlLoadImage(n, m, s, p, l, k, q.AttachImagesForControl, r)
		}
	};
	f.prototype.__SetArrayControlLoadImage = function(n, m, t, q, l, k, s, o) {
		var r = this;
		var p = 0;
		...
		a.aryControlLoadImage.push(new d(n, m, r, t, q, l, k, s, o, r.BaseUrl))
	};
	...
	f.prototype.ZoomIn = function() {
		var o = this;
		if (o.bSingleMode == true) {
			var n = 15000;
			var l = o.aryModelImageControl[o.cCurrentIndex];
			var m = o.fZoom;
			if (o.bIfFitWindow) {
			...
			tempZoom = (Math.floor(m * 100 * o.zoomInStep) + 1);
			if (1 < tempZoom && tempZoom < 2501) {
				if (parseInt(l.imageWidth * o.fZoom) > n || parseInt(l.imageHeight * o.fZoom) > n) {
					Funs2.output(o, "You have reached the limit for zooming in");
					return false
				} else {
					o.SetZoom(tempZoom / 100)
				}
			} else {
				Funs2.output(o, "You have reached the limit for zooming in");
	...
	f.prototype.__GoInner = function(p, s, t) {
		var n = this,
			r = n.cCurrentIndex;
	...
	f.prototype.PrintCurrent = function() {
		var o = this;
		if (o.cCurrentIndex < 0) {
			return
		}
		var l = Funs2.getImageUrl(o.BaseUrl, o.cCurrentIndex, -1, -1);
		var k = o.aryModelImageControl[o.cCurrentIndex];
		var n = [];
	...
	f.prototype.Print = function() {
		...
		var n = [];
		for (i = 0; i < o.aryModelImageControl.length; i++) {
			var l = Funs2.getImageUrl(o.BaseUrl, i, -1, -1);
			var k = o.aryModelImageControl[i];
			var m = new j(l, k.imageWidth, k.imageHeight);
			n.push(m)
		}
		Funs2.print(n);
	...
	f.prototype.SetSelectedImageIndex = function(o, n) {
		var q = this;
		q.aryCurrentSelectedImageIndicesInBuffer[o] = n;
		q.__SetUnselectAll();
		q.__SetSelectedImageIndicesInBuffer();
		var l = -1,
			k = q.aryCurrentSelectedImageIndicesInBuffer.length,
			p;
		for (var m = 0; m < k; m++) {
			var p = q.aryCurrentSelectedImageIndicesInBuffer[m];
			if (l == -1) {
				l = p
			} else {
				if (p < l) {
	...
	f.prototype.__MousewheelUp = function(n) {
		...
		if (o.bSingleMode == false) {
			if (o.__GetIfHScroll() == true || o.__GetIfVScroll() == true) {
				...
				Funs2.output(o, "__MousewheelUp(baseIndex, index): " + [l, m].join(","));
		...
		if (o.bSingleMode == false) {
			if (o.__GetIfHScroll() == true || o.__GetIfVScroll() == true) {
				...
				if (l + o.imagesPerColumn * o.imagesPerRow < o.aryModelImageControl.length) {
					Funs2.output(o, "__MousewheelDown(baseIndex, index): " + [l, m].join(","));
	...
	f.prototype.AddImage = function(n, l, r) {
		var o = this,
			p = n * 1,
			q, s, m, k;
	...
	f.prototype.MoveImage = function(l, t) {
		var o = this,
			r, s, n, m, q, p, k;
		s = o.GetDataImageControlList();
		r = s.length;
		...
		o.UpdateAllImage(s, o.GetCurrentImageIndex(), p, k);
		return true
	};
	...
	a.OnGetImageFromServer = function(t, m, p, r, o, q, l) {
		...
		if (l && q) {
			...
			s.onerror = function(v) {
				...
				u = x.GetDataImageControlList().length;
				if (w >= 0 && w < u) {
					s.ready_src = Funs2.getImageUrl(q, n.GetBindIndex(), r, o);
					setTimeout(function() {
						if (s.ready_src) {
							s.src = s.ready_src
						} else {
...
(function(c) {
	...
	var f = "eng",
		d = c.DOM,
		b = {
			btninfo: ["previous", "next", "", "rotateleft", "rotate", "rotateright", "deskew", "crop", "erase", "changeimagesize", "flip", "mirror", "", "zoomin", "originalsize", "zoomout", "stretch", "fit", "fitw", "fith", "print", "", "hand", "rectselect", "zoom", "", "restore", "save"],
			titlelan: ["eng", "chi"],
			titles: [
				["Previous Image", "Next Image", "", "Rotate Left", "Rotate", "Rotate Right", "Deskew", "Crop Selected Area", "Erase", "Change Image Size", "Flip", "Mirror", "", "Zoom In", "Original Size", "Zoom Out", "Stretch Mode", "Fit Canvas", "Fit Horizontally", "Fit Vertically", "Print", "", "Hand", "Select", "Zoom", "", "Restore", "Save Changes"],
				["Previous Image", "Next Image", "", "Rotate Left", "Rotate", "Rotate Right", "Deskew", "Crop Selected Area", "Erase", "Change Image Size", "Flip", "Mirror", "", "Zoom In", "Original Size", "Zoom Out", "Stretch Mode", "Fit Canvas", "Fit Horizontally", "Fit Vertically", "Print", "", "Hand", "Select", "Zoom", "", "Restore", "Save Changes"]
			]
		},
		e = {
	...
	a.prototype.__NewAryModelImageControl = function(j) {
		...
		for (h = 0; h < j.length; h++) {
			...
			if (l.bOriginalImage) {
				...
				g.bIsDirty = l.bIsDirty;
				g.imageToShow = l.imageToShow;
				g.imageWidth = l.imageWidth;
				g.imageHeight = l.imageHeight;
				g.iImageControlWidth = l.iImageControlWidth;
				g.iImageControlHeight = l.iImageControlHeight
			}
			g.imageIndex = l.imageIndex;
	...
	a.prototype.updateEditor = function() {
		var o = this;
		e.output(o, 'Editor is under mode "' + o.mode + '"');
		if (o.toolbar.self) {
			if (!o.bShow) {
				return
			}
			if (o.toolbar.width + o.toolbar.height == 0) {
				e.addClass(o.toolbar.self, "dynamsoft-dwt-notdisplayed")
			} else {
				o.toolbar.self.style.width = o.toolbar.width + "px";
				o.toolbar.self.style.height = o.toolbar.height + "px";
				if (!o.toolbar.filled) {
					o.toolbar.filled = true;
					while (o.toolbar.self.firstChild) {
						o.toolbar.self.removeChild(o.toolbar.self.firstChild)
					}
					o.toolbar.self.appendChild(e.getToolBar(o, o.toolbar.width, o.toolbar.height));
					if (o._IfImageChanged) {
						var k = c.one(o.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
							n = c.one(o.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
						k[0].style.display = "";
						n[0].style.display = ""
					}
				}
				e.removeClass(o.toolbar.self, "dynamsoft-dwt-notdisplayed");
				e.removeClass(o.toolbar.self, "dynamsoft-dwt-overlay")
			}
			o.iControlWidth = o.width - 2;
			o.iControlHeight = (o.height - o.toolbar.height - 2);
			c.log("ChangeImageViewSize: " + [o.iControlWidth, o.iControlHeight].join(","));
			o._UIView.ChangeImageViewSize(o.iControlWidth, o.iControlHeight);
			o.updateMode()
		} else {
			...
			l.style.width = o.toolbar.width + "px";
			l.style.height = o.toolbar.height + "px";
			l.style.whiteSpace = "normal";
			l.className = "dynamsoft-dwt-viewerToolbar";
			m = document.createElement("div");
			m.id = "ds-dwt-imageViewer" + g;
			m.style.width = o.width + "px";
			m.style.height = (o.height - o.toolbar.height) + "px";
			m.style.backgroundColor = o.backgroundColor;
			...
			o.iControlHeight = (o.height - o.toolbar.height - 2);
			var h = {
				Container: o.container.one(".ds-dwt-imageViewer"),
				Width: o.iControlWidth,
				Height: o.iControlHeight,
				borderWidth: 0
			};
			h.onImageAreaSelected = function(s) {
				...
				o.Bottom = s.bottom;
				var r, p, q;
				r = c.one(o.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_crop");
				if (r && r[0]) {
					q = r[0].src;
				...
				p = c.one(o.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_erase");
				if (p && p[0]) {
					q = p[0].src;
					q = q.replace("erase_grey.", "erase.");
					p[0].src = q;
			...
			h.onImageAreaDeSelected = function() {
				...
				o.Right = 0;
				o.Bottom = 0;
				if (c.one(o.toolbar.self)) {
					o.__SetCropButtonGrey(false);
					o.__SetEraseButtonGrey(false)
				}
			};
			h.onZoomChanged = function(p) {
				o.__SetZoomInButtonEnable(!p.isMax);
				o.__SetZoomOutButtonEnable(true);
				o.__SetCropButtonGrey(true);
				o.__SetEraseButtonGrey(true)
			};
			o._UIView = new c.UI.ImageUIView(h);
			o._UIView.BaseUrl = o.BaseUrl;
			o._UIView.aryModelImageControl = o.aryModelImageControl;
			o._UIView.cCurrentIndex = o.cIndex;
			o._UIView.__fireEvent("onResetCurrentIndex", o.cIndex);
			o._UIView.SetViewMode(-1, -1);
			o.UIEditor.attr("class", j.join(" "));
			o.toolbar.self = document.getElementById("dynamsoft-dwt-viewerToolbar" + g);
			o.updateEditor()
		}
	};
	...
	a.prototype.CloseImageEditor = function() {
		...
		g._UIManager._UIEditor = null;
		g._UIManager = null;
		g._stwain = null;
		g.evt_switch = null;
		g.evt_mouseMove = null;
		g.evt_mouseIn = null;
		g.evt_mouseOut = null;
		g.evt_mouseClick = null;
		g.evt_mouseDblClick = null;
		g.onRefreshUI = false;
		g.onMouseRightClick = false;
		g.onMouseClick = false;
		g.onMouseDoubleClick = false;
		g.onMouseMove = false
	};
	...
	a.prototype.RotateAnyAngle = function(m) {
		...
		k.onclick = function() {
			var t = c.get("dynamsoft_Angle").value;
			...
			var s = c.get("dynamsoft_KeepSize");
			var r = s.checked;
			var o = j.RotateEx(t, r, c.get("dynamsoft_Angle_InterpolationMethod").selectedIndex + 1);
	...
	a.prototype.ChangeImageSizeGetinput = function(m) {
		...
		g.onclick = function() {
			var s = c.get("dynamsoft_img_width").value,
				o = c.get("dynamsoft_img_height").value;
			...
			var r = j.ChangeImageSize(s, o, c.get("dynamsoft_InterpolationMethod").selectedIndex + 1);
			if (j._stwain.ErrorCode == 0) {
				c.hide("dynamsoft_ImgSizeEditor");
				return
			}
	...
	a.prototype.Erase_btn = function() {
		var j = this,
			h, g = c.one(j.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_erase");
		if (g && g[0]) {
			h = g[0].src;
			if (h.indexOf("grey") != -1) {
				return
	...
	a.prototype.Erase = function() {
		...
		if (parseInt(k) - parseInt(h) != 0 && parseInt(j) - parseInt(g) != 0) {
			l._IfImageChanged = true;
			l._stwain.Erase(l.cIndex, parseInt(k), parseInt(j), parseInt(h), parseInt(g));
			l.__SetEraseButtonGrey(true)
		} else {
			e.output(l, "No area selected for cropping");
			return
	...
	a.prototype.ZoomOut = function() {
		var g = this;
		if (g._UIView && g._UIView.ZoomOut()) {
			g.__SetZoomOutButtonEnable(true);
			g.__SetZoomInButtonEnable(true)
		} else {
	...
	a.prototype.__EnableMouseShapButtons = function(o) {
		var j = this,
	...
	a.prototype.__RestoreImageInner = function(k, h, n) {
		...
		var j = function(r, u, s) {
			if (k == true) {
				c.log("__RestoreImageInner: " + [u.imageIndex].join(","));
				u.bOriginalImage = true;
				if (o._UIView && r.GetBindIndex() == s) {
					o._UIView.AttachImagesForControl(r, u)
				}
			}
			o._IfImageChanged = false;
			var p = o.aryModelImageControl[s];
			if (p != null) {
			...
			o._UIManager.getView().SetDataImageControl(s);
			var q = c.one(o.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
				t = c.one(o.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
			if (q && q[0]) {
			...
			if (h == -1) {
				o._stwain._OnBitmapChanged(["0", o.cIndex.toString(), 4, o.cIndex, o._UIView.sHowManyImages])
			}
		};
		var m = true;
		if (o._UIView && o._IfImageChanged == true) {
			var g = o._UIView.GetImageControl(o.cIndex);
			if (null != g) {
				g.SetCurrentIndex(o.cIndex);
				o.OnGetImageFromServerForEdit(g, o.aryModelImageControl[o.cIndex], o.cIndex, 1, j);
				m = false
			}
		}
		if (m) {
	...
	a.prototype.OnGetImageFromServerForEdit = function(g, m, k, l, n) {
		...
		if (n && o.BaseUrl) {
			g.ClearImage();
			g.SetBindIndex(k);
			j = Funs2.getUrlByAct(o.BaseUrl, k, l);
			h = new Image();
			h.src = j;
			h.onload = function() {
				g.tmpImage = false;
			...
			h.onerror = function(r) {
				var s = g.GetBindIndex(),
					q = o._stwain,
					p = q.HowManyImagesInBuffer;
				if (s >= 0 && s < p) {
					h.ready_src = Funs2.getImageUrl(o.BaseUrl, g.GetBindIndex(), l);
					setTimeout(function() {
						if (h.ready_src) {
							h.src = h.ready_src
						} else {
	...
	a.prototype.__SaveImageInner = function(j, m) {
		...
		var h = function(q, t, r) {
			if (j == true) {
				c.log("__SaveImageInner: " + [t.imageIndex].join(","));
				t.bOriginalImage = true;
				if (n._UIView && q.GetBindIndex() == r) {
					n._UIView.AttachImagesForControl(q, t)
				}
			}
			n._IfImageChanged = false;
			var o = n.aryModelImageControl[r];
			if (o != null) {
				o.imageToShow = t.imageToShow;
				o.imageWidth = t.imageWidth;
				o.imageHeight = t.imageHeight;
				o.imageUrl = t.imageUrl
			}
			n._UIManager.getView().SetDataImageControl(r);
			var p = c.one(n.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_save"),
				s = c.one(n.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_restore");
			if (p && p[0]) {
		...
		var l = true;
		if (n._UIView && n._IfImageChanged == true) {
	...
	a.prototype.ShowDialogForSaveImage = function(h, l) {
		var m = this;
		var j = ['<div class="dynamsoft-dwt-dlg-tips">', "<div>", "You have changed the image, do you want to keep the change(s)?", "</div>", '<div style="width: 200px;white-space:nowrap;margin-left: auto;margin-right: auto;">', '<input class="dynamsoft_btnSave" style="width: 100px; height:30px; margin-right: 10px; margin-top: 10px;"  type="button" value="  OK  "/>', '<input class="dynamsoft_btnCancel" style="width: 100px; height:30px;"  type="button" value="  NO  " />', "</div>", "</div>"];
		Dynamsoft.WebTwainEnv.ShowDialog(420, 0, j.join(""), true);
		var g = c.one(".dynamsoft_btnSave").getEL();
		if (g) {
			g.onclick = function() {
		...
		var k = c.one(".dynamsoft_btnCancel").getEL();
		if (k) {
			k.onclick = function() {
	...
	a.prototype.__SetEraseButtonGrey = function(k) {
		var l = this;
		l.Left = 0;
		l.Top = 0;
		l.Right = 0;
		l.Bottom = 0;
		var h = c.one(l.toolbar.self).one(".dynamsoft-dwt-Editor_Buttons_erase");
		if (h && h[0]) {
			var j = h[0].src;
			j = j.replace("erase.", "erase_grey.");
			h[0].src = j;
			h.style("cursor", "auto")
		}
		if (l._UIView && k) {
...
(function(a) {
	...
	e.prototype.ShowImageEditorEx = function(n, m, h, g, k) {
		...
		o = {
			Container: a.one(f),
			aryModelImageControl: r.GetDataImageControlList(),
			BaseUrl: r.BaseUrl,
			cIndex: r.cCurrentIndex,
			stwain: l.getTwain()
		};
		q = new Dynamsoft.Lib.UI.ImageUIEditor(l, o);
		l._UIEditor = q;
		q.bShow = false;
		q.bShow = true;
		return q.ShowImageEditorEx(n, m, h, g, 0)
	};
...
(function(a, F) {
	var I = dynamsoft.navInfo,
		P = dynamsoft.dcp,
		N = !1,
		S = "The Dynamic Web TWAIN module is not installed.",
		u = {
			curPortIndex: 0,
			bConnected: false,
			versionInfo: function(Y, X) {
				var W = 0,
					U = function(ae, ab) {
						var aa = [u._getPreUrl(Y[u.curPortIndex]), "f/VersionInfo?ts=", a.now()].join(""),
							Z, ad;
					...
					V = function() {
						u.curPortIndex++;
						u.bConnected = false;
						if (u.curPortIndex < Y.length) {
							setTimeout(function() {
								U(T, V)
							}, 1000)
						} else {
							F.OnWebTwainInitMessage && F.OnWebTwainInitMessage(S, EnumDWT_InitMsg.NotInstalledError);
	...
	var H = window,
		m = H.document,
		k, n, Q = "This browser is currently not supported.",
		A = "Duplicate ID detected for creating Dynamic Web TWAIN objects, please check and modify.",
		J = a.each,
		f = "dwt",
		j = 0,
		C = 1,
	...
	k = function(ae, W, ab, T) {
		var U = (navigator.userAgent.toLowerCase()),
			ad = a.product;
		if (T && T._customIP && (!a.isLocalIP(T._ip))) {
			if (a.isFunction(OnRemoteWebTwainNotFoundCallback)) {
		...
		if (a.env.bMac) {
			...
			if (a.isFunction(OnWebTwainNotFoundOnMacCallback)) {
			...
			if (a.env.bLinux) {
				...
				if (a.isFunction(OnWebTwainNotFoundOnLinuxCallback)) {
					var Z, ac;
				...
				if (U.match(/chrome\/([\d.]+)/) || U.match(/opera.([\d.]+)/) || U.match(/version\/([\d.]+).*safari/) || U.match(/firefox\/([\d.]+)/) || F.IfUseActiveXForIE10Plus == N || (!F.ActiveXInstallWithCAB && a.env.bIE)) {
					...
					if (a.isFunction(OnWebTwainNotFoundOnWindowsCallback)) {
						var Y = "";
	...
	var L = function(V, Y) {
			if (a.isFunction(OnWebTwainNeedUpgradeCallback)) {
				var T = {},
					X;
				if (a.env.bWin) {
					if (a.product.bChromeEdition) {
					...
					X = EnumDWT_PlatformType.enumWindow
				} else {
					if (a.env.bLinux) {
						var W, U;
						W = a.product.getLinuxHTML5DebPath();
						U = a.product.getLinuxHTML5RpmPath();
						T["default"] = W;
						T.deb = W;
						T.rpm = U;
						X = EnumDWT_PlatformType.enumLinux
					} else {
						if (a.product.bChromeEdition) {
							T["default"] = a.product.getChromeEditionPath()
						} else {
						...
						X = EnumDWT_PlatformType.enumMac
					}
				}
				OnWebTwainNeedUpgradeCallback(a.product.name, T, a.product.bChromeEdition, X, a.env.bIE, a.env.bSafari, a.detect.ssl, a.env.strIEVersion, a.detect.bPromptJSOrServerOutdated, V, Y)
			}
		},
		l = function(T, V) {
			if (!a.detect.bNeedUpgradeEvent && !a.detect.isDWTVersionLatest(V.VersionInfo)) {
				a.detect.bNeedUpgradeEvent = z;
				if (!F.UseDefaultInstallUI && a.isFunction(F.OnWebTwainNeedUpgrade)) {
					F.OnWebTwainNeedUpgrade();
					return
				}
				if (V && V._customIP && (!a.isLocalIP(V._ip))) {
					if (a.isFunction(OnRemoteWebTwainNeedUpgradeCallback)) {
	...
	var p = function(T) {
						...
						if (Y.ErrorCode == -2207) {
							if (!F.UseDefaultInstallUI && a.isFunction(F.OnWebTwainNeedUpgradeWebJavascript)) {
								...
								if (!a.detect.bPromptJSOrServerOutdated) {
									a.detect.bPromptJSOrServerOutdated = z
								}
							}
						}
					}
		...
		h = function(T) {
			T.IfAllowLocalCache = z;
			T.BrokerProcessType = 1;
			T.IfShowFileDialog = z;
			T.IfDisableSourceAfterAcquire = z;
	...
	var o = function() {
		...
		q = function(X, U, T) {
			...
			u.versionInfo(aa, function(af, ai) {
				if (ai && ai.length > 0) {
					if (M(ai, F.ServerVersionInfo)) {
						a.detect.hideMask();
						V.dcpStatus = t;
						a.product.ip = dynamsoft.dcp.ip;
						g(dynamsoft.dcp.ip, af);
						if (a.isFunction(X.callback)) {
							X.callback()
						}
						return
				...
				if (!U) {
					...
					var ak = F.Trial ? "Trial_" : "",
						ag = [F.ResourcesPath, "/", ah, ak, a.replaceAll(F.ServerVersionInfo, ",", "."), ".zip?t=", a.getRandom()].join(""),
						aj = function(al) {
							var am = 0;
							dynamsoft.dcp.loadZip(al, am, function() {
								if (a.isFunction(OnWebTWAINDllDownloadSuccessful)) {
									OnWebTWAINDllDownloadSuccessful()
								}
								if (F.OnWebTwainInitMessage) {
									var an;
									if (Z.bSSL && a.env.bFirefox) {
										an = "Please REFRESH your browser.";
										F.OnWebTwainInitMessage && F.OnWebTwainInitMessage(an, EnumDWT_InitMsg.DownloadNotRestartError);
										return
									}
									an = "The Dynamic Web TWAIN module loaded.";
									F.OnWebTwainInitMessage(an, EnumDWT_InitMsg.Info)
								}
								setTimeout(function() {
									q(X, z)
								}, 10)
						...
						ad = function(al, ao, an) {
							a.detect.hideMask();
							var aq = z;
							if (F.OnWebTwainInitMessage) {
								var ar = "Failed to download the Dynamic Web TWAIN module.";
								F.OnWebTwainInitMessage(ar, EnumDWT_InitMsg.DownloadError)
							}
							if (a.isFunction(OnWebTWAINDllDownloadFailure)) {
								var ap = {},
									am;
								if (an.status == 404) {
									a.Errors.WebTwainModuleNotExist(ap);
									am = z
								} else {
									a.Errors.WebTwainModuleDownloadFailure(ap);
									am = N
								}
								aq = OnWebTWAINDllDownloadFailure(a.product.name, ap._errorCode, ap._errorString);
								if (am) {
									aq = N
								}
							}
					...
					if (F.OnWebTwainInitMessage) {
						var ae = "Downloading the Dynamic Web TWAIN module.";
						F.OnWebTwainInitMessage(ae, EnumDWT_InitMsg.Info)
					}
					new a.ajax({
						method: "GET",
						url: ag,
		...
		B = function(Y) {
			var W = dynamsoft.initOrder,
				aa = false;
			if (W.length > 0 && W[0] === f) {
				var ac = function() {
						if (F.OnWebTwainInitMessage) {
							var ae = "Please download and install the Dynamic Web TWAIN.";
							F.OnWebTwainInitMessage(ae, EnumDWT_InitMsg.Info)
						}
						if (!a.isLocalIP(dynamsoft.dcp.ip)) {
							if (a.isFunction(OnRemoteWebTwainNotFoundCallback)) {
								var ad = I.bSSL;
								OnRemoteWebTwainNotFoundCallback(a.product.name, dynamsoft.dcp.ip, Y.dwtPort, ad)
							}
						} else {
							k()
						}
					...
					X = function() {
						var ae = false;
						if (a.isFunction(OnWebTwainShowUpdatingDialog)) {
							ae = OnWebTwainShowUpdatingDialog()
						}
						if (!ae) {
							var ad = ['<div class="dynamsoft-dwt-dlg-tips dynamsoft-dwt-dlg-center">', "Dynamsoft Service is updating ...", "</div>", '<div style="padding-top:35px"></div>'];
							F.ShowDialog(365, 0, ad.join(""), 0, 1)
						}
						return true
					},
					T = function() {
						var ad = false;
						if (a.isFunction(OnWebTwainCloseUpdatingDialog)) {
							ad = OnWebTwainCloseUpdatingDialog()
						}!ad && F.CloseDialog();
						return true
					},
					Z = function(ad, ae) {
				...
				dynamsoft.dcp.checkDcpForUpdate(ac, U, V, X, T, Z, ab)
			} else {
		...
		K = function(V, W) {
			...
			if (T.length > 0 && T[0] === f) {
				...
				if (U.dcpStatus === j || W) {
					...
					if (U.dcpStatus === C || U.dcpStatus === v) {
						if (!a.env.stopCheckingForService) {
							setTimeout(function() {
								K(V, W)
							}, 500)
